        ...
        <div class="row lead">
            <div class="col-lg-6 mt-5">
                <ul class="list-unstyled w-75 mx-auto float-lg-right">
                    ...
                    <li>
                        <p>
                            <i class="fa fa-check mr-3 text-primary"></i>Create your sales invoice right here in your browser and download the PDF
                        </p>
                    </li>
                    <li>
                        <p>
                            <i class="fa fa-check mr-3 text-primary"></i>Add multiple columns and rows as required in your sales invoice
                        </p>
                    </li>
                    <li>
                        <p>
                            <i class="fa fa-check mr-3 text-primary"></i>Add your company logo and set your invoice colors as per your brand
                        </p>
                    </li>
                    <li>
                        <p>
                            <i class="fa fa-check mr-3 text-primary"></i>Automatic calculation of taxes, sub totals and grand total
                        </p>
                    </li>
                    <li>
                        <p>
                            <i class="fa fa-check mr-3 text-primary"></i>Printer friendly sales invoices, perfect to provide paper invoices to customers
                        </p>
                    </li>
                    <li>
                        <p>
                            <i class="fa fa-check mr-3 text-primary"></i>GST compliant sales invoice format
                        </p>
                    </li>
                    <li>
                        <p>
                            <i class="fa fa-check mr-3 text-primary"></i>A great invoice design to impress clients!
                        </p>
                    </li>
                </ul>
            </div>
            <div class="col-lg-6 mt-5">
                <ul class="list-unstyled w-75 mx-auto float-lg-left">
                    ...
                    <li>
                        <p>
                            <i class="fa fa-check mr-3 text-primary"></i>Send sales invoices via email to your customers mailbox
                        </p>
                    </li>
                    <li>
                        <p>
                            <i class="fa fa-check mr-3 text-primary"></i>Send sales invoice via SMS to your customers
                        </p>
                    </li>
                    <li>
                        <p>
                            <i class="fa fa-check mr-3 text-primary"></i>Add online payment options to your sales invoices
                        </p>
                    </li>
                    <li>
                        <p>
                            <i class="fa fa-check mr-3 text-primary"></i>Automated reminders sent to customers for pending sales invoices
                        </p>
                    </li>
                    <li>
                        <p>
                            <i class="fa fa-check mr-3 text-primary"></i>All your company invoices saved in your secure account
                        </p>
                    </li>
                    <li>
                        <p>
                            <i class="fa fa-check mr-3 text-primary"></i>Customize all aspects of your sales invoice
                        </p>
                    </li>
                    <li>
                        <p>

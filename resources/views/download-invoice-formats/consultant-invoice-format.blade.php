            ...
            <table class="table table-bordered  table-condensed mb-1">
                ...
                <tbody>
                    <tr>
                        ...
                        <td class="tdpr" >
                            <input class="form-control form-control-plaintext form-control-sm text-center" required="" type="number" step="0.01" id="p_qty" onblur="calculateConsultant();" name="p_qty" placeholder="Enter value">
                        </td>

                        <td class="tdpr" >
                            <input class="form-control form-control-plaintext form-control-sm text-center" id="p_rate" required="" type="number" step="0.01" name="p_rate" onblur="calculateConsultant();" placeholder="Enter value">
                        </td>

                        <td class="tdpr">
                            <div class="input-group"><input class="form-control form-control-plaintext form-control-sm text-right" name="p_cost" readonly="" required="" type="number" step="0.01"   onblur="calculateConsultant();" id="p_cost" value="0.00" placeholder="Enter amount">
                    ...
                    <tr id="newrow" style="display: none;">
                        ...
                        <td class="tdpr" >
                            <input class="form-control form-control-plaintext form-control-sm text-center" id="p_qty2" type="number" step="0.01" name="p_qty2" onblur="calculateConsultant();" placeholder="Enter value">
                        </td>

                        <td class="tdpr" >
                            <input class="form-control form-control-plaintext form-control-sm text-center" id="p_rate2" type="number" step="0.01" name="p_rate2" onblur="calculateConsultant();" placeholder="Enter value">
                        </td>


                        <td class="tdpr">
                            <div class="input-group"><input class="form-control form-control-plaintext form-control-sm text-right" id="p_cost2" readonly="" name="p_cost2" required="" type="number" step="0.01"   onblur="calculateConsultant();" value="0.00"  placeholder="0.00">
                    ...
                    <tr style="text-align: center;">
                        <td colspan="4" rowspan="7" id="tnc_col" class="pb-2 border-bottom-0">
...
1. Type your terms and conditions here</textarea>
                        ...
                        <td colspan="1" class="td-firstcol">
                            <b>Sub Total</b>
                        </td>
                        <td class="col-span"  >
                    ...
                    <tr class="d-none" id="tax4-tr">
                        ...
                        <td colspan="2"  colspan="">
                            <select placeholder="GST" name="tax_name4" onchange="calculateConsultant();"  id="tax_name4" class="form-control form-control-plaintext form-control-sm">
                                <option value="">Not applicable</option>
                                <option value="CGST@2.5%">CGST@2.5%</option>
                                <option value="SGST@2.5%">SGST@2.5%</option>
                                <option value="IGST@5%">IGST@5%</option>
                    ...
                    <tr>
                        ...
                        <td colspan="1" class="td-firstcol"><b>Total Rs.</b></td>
                    ...
                    <tr >
                        ...
                        <td colspan="1" class="td-firstcol"><b>Past due</b></td>
                        <td class="col-span" ><b> <input class="form-control form-control-plaintext form-control-sm text-right" id="past_due" onblur="calculateConsultant();" type="number" step="0.01" name="past_due" placeholder="Past dues, if applicable"> </b></td>
                    </tr>
                    <tr >
                        <td colspan="1" >GST Number</td>
                    ...
                    <tr>
                        ...
                        <td colspan="2" class="bg-grey2 col-span4 pr-1 text-right" style="font-size:15px;">
                    ...
                    <tr style="text-align: center;">
                        <td colspan="4" class="bg-light-blue lead border-right-0">
                            Get paid faster by collecting payments online
                        </td>
                        <td colspan="2" class="bg-light-blue border-left-0 col-span4" >
                            <a href="javascript:" class="btn btn-sm btn-primary pull-right" onclick="setRegText(6);" >Add online payment option</a>
                        </td>
                    </tr>

                    <tr >
                        <td colspan="4" class="text-left border-right-0" style="font-size:12px;">
                            <b> * Note: </b>This  is a system generated invoice. No signature required.
                        </td>
                        <td colspan="2" class="col-span4 border-left-0" style="font-size:12px;">

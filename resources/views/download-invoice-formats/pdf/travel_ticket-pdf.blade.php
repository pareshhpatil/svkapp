        ...
        <section class="jumbotron jumbotron-features bg-transparent py-4" id="header">
            <div class="container">
                <div class="row align-items-center">
                            ...
                            <tbody><tr>
                                ...
                                <tr>
                                    <td style="padding-bottom: 0;padding-top: 0;">
                                        ...
                                        <table width="100%" border="0" cellspacing="0" cellpadding="5" style="border: 1px solid #cbcbcb;color:#5b4d4b;font-size: 13px;line-height: 15px;text-align: center;">
                                            <thead>
                                                <tr>
                                                    ...
                                                    @endif
                                                    <th  @if($time_period_label=='') colspan="2" @endif style="border-bottom: 1px solid #cbcbcb;border-right: 1px solid #cbcbcb;min-width: 70px;">
                                                          Name
                                                </th>
                                        ...
                                        <tbody>
                                            <tr> 
                                                ...
                                                @endif
                                                <td @if($time_period_label=='') colspan="2" @endif  style="border-bottom: 1px solid #cbcbcb;border-right: 1px solid #cbcbcb;">
                                                     {{$p_name1}}
                                            </td>
                                            <td style="border-bottom: 1px solid #cbcbcb;border-right: 1px solid #cbcbcb;">
                                                {{$p_type1}}
                                    ...
                                    <tr >
                                        ...
                                        <td   style="border-bottom: 1px solid #cbcbcb;text-align: right;border-right: 1px solid #cbcbcb;"class="border-left-0" colspan="6">
                                            <b class="pull-right">Total Rs.</b>

                                        </td>
                                        @if($p_amount2=='') @php $p_amount2=0; @endphp @endif
                                        @if($p_scharge2=='') @php $p_scharge2=0; @endphp @endif
                                        ...
                                        <td   style="border-bottom: 1px solid #cbcbcb;text-align: right;border-right: 1px solid #cbcbcb;"class="tdpr" >
                                            <b id="tp_amt">{{ number_format($p_amount1 + $p_amount2, 2) }}</b>
                                        </td>
                                        <td   style="border-bottom: 1px solid #cbcbcb;text-align: right;border-right: 1px solid #cbcbcb;"class="tdpr" >
                                            <b id="tp_scharge">{{ number_format($p_scharge1 + $p_scharge2, 2) }}</b>
                                        </td>
                                        <td    style="border-bottom: 1px solid #cbcbcb;text-align: right;border-right: 1px solid #cbcbcb;"class="tdpr">
                    ...
                    <tr>
                        <td style="padding-bottom: 0;padding-top: 0;">
                            <p style="font-size: 14px;margin:5px; margin-bottom: 5px;">Cancellation details</p>
                            <table width="100%" border="0" cellspacing="0" cellpadding="5" style="border: 1px solid #cbcbcb;color:#5b4d4b;font-size: 13px;line-height: 15px;text-align: center;">
                                <thead>
                                    <tr>
                                ...
                                <tbody>
                                    <tr> 
                                        ...
                                        <td   style="border-bottom: 1px solid #cbcbcb;text-align: right;">
                                            @if($c_cost=='') @php $c_cost=0; @endphp @endif
                                            {{ number_format($c_cost, 2) }}
                                        </td>
                                    </tr>

                                    <tr >
                                        @if($c_amount1=='') @php $c_amount1=0; @endphp @endif
                                        @if($c_scharge1=='') @php $c_scharge1=0; @endphp @endif
                                        <td   style="border-bottom: 1px solid #cbcbcb;text-align: right;border-right: 1px solid #cbcbcb;"class="border-left-0" colspan="6">
                                            <b class="pull-right">Total Rs.</b>
                                        ...
                                        <td   style="border-bottom: 1px solid #cbcbcb;text-align: right;border-right: 1px solid #cbcbcb;"class="tdpr" >
                                            <b id="tp_amt">{{ number_format($c_amount1, 2) }}</b>
                                        </td>
                                        <td   style="border-bottom: 1px solid #cbcbcb;text-align: right;border-right: 1px solid #cbcbcb;"class="tdpr" >
                                            <b id="tp_scharge">{{ number_format($c_scharge1, 2) }}</b>
                                        </td>
                                        <td    style="border-bottom: 1px solid #cbcbcb;text-align: right;border-right: 1px solid #cbcbcb;"class="tdpr">
                                            <b id="tp_cost">{{ number_format($c_cost, 2) }}</b>
                            ...
                            <table width="100%" border="0" cellspacing="0" cellpadding="5" style="border: 1px solid #cbcbcb;color:#5b4d4b;font-size: 13px;line-height: 15px;text-align: center;">
                                ...
                                <tbody>
                                    ...
                                    <tr >
                                        ...
                                        <td    style="border-bottom: 1px solid #cbcbcb;text-align: right;border-right: 1px solid #cbcbcb;"class="tdpr">
                                            @if($tax1=='') @php $tax1=0; @endphp @endif
                                            @if($tax2=='') @php $tax2=0; @endphp @endif
                            ...
                            <table style="margin:0 auto; font-family:Verdana, Arial;" align="center" width="100%" border="0" cellspacing="0" cellpadding="10">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td class="bgset2"  style="width: 260px; text-align:right; font-size:16px;vertical-align: middle;font-family: Open Sans, sans-serif;">

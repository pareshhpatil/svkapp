                ...
                <div class="row align-items-center">
                    ...
                    <div class="d-none d-lg-block col-12 col-md-12 col-lg-12 col-xl-12">
                        <table style="margin:0 auto; font-family: Open Sans, sans-serif;width: 750px; border: 1px solid grey;" align="center" border="0" cellspacing="0" cellpadding="10">
                            <tbody><tr>
                                ...
                                <tr>
                                    <td>
                                        ...
                                        <table width="100%" border="0" cellspacing="0" cellpadding="5" style="border: 1px solid #cbcbcb;color:#5b4d4b;font-size: 13px;line-height: 15px;text-align: center;">
                                            <thead>
                                                <tr >
                                                    ...
                                                    <th  @if($time_period_label=='') colspan="2" @endif style="border-bottom: 1px solid #cbcbcb;border-right: 1px solid #cbcbcb; min-width: 110px;">
                                                          {{$description_label}}  
                                                </th>
                                        ...
                                        <tbody>
                                            <tr> 
                                                ...
                                                <td  @if($time_period_label=='') colspan="2" @endif style="border-bottom: 1px solid #cbcbcb;border-right: 1px solid #cbcbcb; widtd: 35%;">
                                                      {{$p_description}}  
                                            </td>
                                            @if($time_period_label!='')
                                            <td style="border-bottom: 1px solid #cbcbcb;border-right: 1px solid #cbcbcb; width: 20%;">
                                                {{$p_time_period}}
                                            </td>
                                            @endif
                                    ...
                                    <tr> 
                                            ...
                                            @if($time_period_label!='')
                                            <td style="border-bottom: 1px solid #cbcbcb;border-right: 1px solid #cbcbcb; widtd: 20%;">
                                                {{$p_time_period2}}
                                            </td>
                                            @endif
                                            <td style="border-bottom: 1px solid #cbcbcb;border-right: 1px solid #cbcbcb;">
                            ...
                            <tr style="text-align: center;">
                                <td colspan="5" rowspan="{{$rowspan}}" style="">
                                    @if($tnc!='')
                                ...
                                <td  style="border-bottom: 1px solid #cbcbcb;text-align: right;">
                                     <b> @if($sub_total>0){{ number_format($sub_total, 2) }}@else 0.00 @endif  </b>
                                </td>
                            </tr>
                           @if($tax1>0)
                            <tr style="text-align: center;">
                    ...
                    @endif
                        ...
                        <tr style="text-align: center;">
                            ...
                            <td style="border-bottom: 1px solid #cbcbcb;text-align: right;">
                                 @if($tax3>0){{ number_format($tax3, 2) }}@else 0.00 @endif
                        </td>
                    </tr>
                    @endif
                        @if($tax4>0)
                        <tr style="text-align: center;">
                            ...
                            <td style="border-bottom: 1px solid #cbcbcb;text-align: right;">
                                 @if($tax4>0){{ number_format($tax4, 2) }}@else 0.00 @endif
                        </td>
                    </tr>
                    @endif
                    <tr style="text-align: center;">
                        ...
                        <td  style="border-bottom: 1px solid #cbcbcb;text-align: right;"><b>@if($total_amount>0){{ number_format($total_amount, 2) }}@else 0.00 @endif  </b></td>
                    </tr>
                    @if($past_due>0)
                    <tr style="text-align: center;">
                        ...
                        <td style="border-bottom: 1px solid #cbcbcb;text-align: right;">@if($past_due>0){{ number_format($past_due, 2) }}@else 0.00 @endif  </td>
                    </tr>
                    @endif
                    @if($gst!='')
                    <tr style="text-align: center;">
                        ...
                        <td  style="text-align: right;border-bottom: 1px solid #cbcbcb;">{{$gst}}</td>
                    </tr>
                    @endif
                    <tr>

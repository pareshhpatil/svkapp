                            ...
                            <tbody><tr>
                                ...
                                <tr style="border-spacing: 0px;">
                                    <td class="bgset" style="text-align: center;border-top: 1px solid grey;border-bottom: 1px solid grey;font-size:18px;">
                                        <b>@isset($invoice_title) {{$invoice_title}} @else TAX INVOICE @endisset</b>
                                    </td>
                                </tr>
                                <tr>
                                ...
                                <tr>
                                    ...
                                    <tr style="text-align: center;">
                                        <td colspan="8" rowspan="{{$rowspan}}" style="">
                                            @if($tnc!='')
                                    ...
                                    <tr style="text-align: center;">
                                        ...
                                        <td  style="border-bottom: 1px solid #cbcbcb;text-align: right;"><b>{{ number_format($total_amount, 2) }} </b></td>
                                    </tr>
                                    @if($past_due>0)
                                    <tr style="text-align: center;">
                                        ...
                                        <td style="border-bottom: 1px solid #cbcbcb;text-align: right;">{{ number_format($past_due, 2) }} </td>
                                    </tr>
                                    @endif
                                    @if($gst!='')
                                    <tr style="text-align: center;">

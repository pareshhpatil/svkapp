    ...
    <div class="container">
        <div class="row align-items-center">
            <div class="col-12 col-md-12 col-lg-6 col-xl-5 d-none d-lg-block">
                <h1>Login failed. SSO token validation error</h1>
                <p class="lead mb-5">to help resolve this error please contact the support team</p>
            </div>
            <div class="col-12 col-md-8 m-auto ml-lg-auto mr-lg-0 col-lg-6 pt-5 pt-lg-0 d-none d-lg-block">
                <img alt="Partner program to earn recurring revenue" class="img-fluid" src="{!! asset('static/images/404.svg') !!}" />
            </div>
            <!-- for iPad and mobile -->

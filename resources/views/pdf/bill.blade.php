                                    ...
                                    <td colspan="2">
                                        <table class="table table-bordered" style="font-size: 12px; color: black !important;">
                                            <tbody>
                                                ...
                                                <tr>
                                                    <td class="tds" colspan="3" rowspan="3" style="vertical-align: middle;font-weight: bold;"><span class="pull-right"><b style="font-weight: bold;">Goods and Services Tax @5%</b></span></td>
                                                ...
                                                <tr>
                                                    ...
                                                    <td class="tds"><span class="pull-right" style="text-align: right;float: right;">@if($invoice->sgst>0)2.50 @else 00 @endif%</span></td>
                                                ...
                                                <tr>
                                                    <td  class="tds" colspan="5" style="text-align: right;font-weight: bold;"><span class="pull-right"><b style="font-weight: bold;">Grand Total (Inclusive of GST)</b></span></td>
...
<img style="width:300px;" src="{{ asset('dist/img/sign.png') }}">
                ...
                <div class="row">
                    <div class="col-xs-8" >Narrative: {{$invoice->narrative}}</div>
                    <div class="col-xs-4" >
                        Name Of Signatory
                    </div>
                </div>

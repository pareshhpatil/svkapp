...
<div class="panel " style="margin-left: -50px;margin-right: -50px;margin-top: -50px;margin-bottom: -30px;">
    <div class="panel-body">
        <div class="row"  >
            <div class="col-md-12">
            <table width="1000" class="table table-bordered" style="font-size: 10px;color: black !important;text-align: center;width: 100% !important;">
                <tbody>
                    <tr>
                        <td colspan="10" class="td-c " style="font-size: 17px;font-weight: bold; padding: 10px;">{{$company_name}}</td>
                    </tr>
                    <tr>
                        <td colspan="10" class="td-c " style="font-size: 12px;font-weight: bold;padding: 5px;">
                            {{$company->name}} 
                            <br>

                ...
                <tr>
                    <td>
                        <table width="290" border="0" cellspacing="0" cellpadding="5" style="color:#5b4d4b;font-size: 13px;line-height: 14px;">
                            <tr style="line-height: 17px;"><td> <b>PO no. </b> : {{$detail->expense_no}}</td></tr>
                            <tr style="line-height: 17px;"><td> <b>Vendor name</b> : {{$detail->vendor_name}}</td></tr>
                    ...
                    <td>
                        ...
                        <table width="290" border="0" cellspacing="0" cellpadding="5" style="color:#5b4d4b;font-size: 13px;line-height: 15px;">
                            <tr style="line-height: 17px;"><td> <b>Category </b> : {{$detail->category}}</td></tr>
                            <tr style="line-height: 17px;"><td> <b>Department </b> : {{$detail->department}}</td></tr>
                            <tr style="line-height: 17px;"><td> <b>Reff no </b> : {{$detail->invoice_no}}</td></tr>
                            <tr style="line-height: 17px;"><td> <b>Date </b> : {{ Helpers::htmlDate($detail->bill_date) }} </td></tr>
                            <tr style="line-height: 17px;"><td> <b>Expected delivery date </b> : {{ Helpers::htmlDate($detail->due_date) }} </td></tr>
                        </table>
                    </td>
                </tr>
            </table>

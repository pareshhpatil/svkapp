...
<body style="min-width:380px;word-break: break-word; -webkit-font-smoothing: antialiased; margin: 0; width: 100%; padding: 0">
    <div role="article" aria-roledescription="email" aria-label="" lang="en">
        <table style="width: 100%" cellpadding="0" cellspacing="0" role="presentation">
            <tr>
                <td align="center" style="@if($viewtype=='mailer')padding-top: 20px; padding-bottom: 20px;@endif background-color: #F7F8F8">
                    <table class="sm-w-full" style="width: 760px" cellpadding="0" cellspacing="0" role="presentation">
                        <tr>
                                    ...
                                    <td style="padding: 5px">
                                        <table style="width: 100%" cellpadding="0" cellspacing="0" role="presentation">
                                            <tr>
                                                ...
                                                <td style="padding: 5px; vertical-align: top; border-top: 2px solid {{$info['design_color']}}">
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td style="border-bottom: 1px solid gray ">
                                                                <div style="margin-top: 8px;padding-top: 3px;padding-bottom: 3px;">
                                                                    ...
                                                                    <span style="margin-top: 4px; font-size: 14px; font-weight: 600; color: #000">{{$item['column_name']}}: </span><span style="font-size: 14px; color: #000">{{$item['value']}}</span>
                                                                </div>
                                                        ...
                                                        <tr>
                                                            <td style="border-bottom: 1px solid gray ">
                                                                <div style="margin-top: 2px;padding-top: 3px;padding-bottom: 3px;">
                                                                    ...
                                                                    <span style="margin-top: 4px; font-size: 14px; font-weight: 600; color: #000">{{$item['column_name']}}: </span><span style="font-size: 14px; color: #000"><x-localize :date="$item['value']" type="date" /></span>
                                                                </div>
                                        ...
                                        <table style="margin-top: 16px; width: 100%" cellpadding="0" cellspacing="0" role="presentation">
                                            <tr>
                                                <td style="width:50%;border-top: 1px solid gray; border-bottom: 1px solid gray; padding: 4px">
                                                    <div style="padding-top:5px;padding-bottom:4px; font-size: 14px; font-weight: 700; color: #000">Bill To</div>
                                            ...
                                            <table style="margin-left: auto; margin-right: auto; width: 100%; background-color: #fff" cellpadding="0" cellspacing="0" role="presentation">
                                                ...
                                                <tbody>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td style="min-width:60px;padding-top: 8px; padding-bottom: 8px; text-align:center; border-bottom: 1px dotted gray;font-size: 12px;">

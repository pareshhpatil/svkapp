  ...
  <div role="article" aria-roledescription="email" aria-label="" lang="en"> <table style="width: 100%" cellpadding="0" cellspacing="0" role="presentation">
      ...
      @endforeach
           ...
           <td style="vertical-align: top;text-align: center;width: 33%;">
                       ...
                       <img @if($viewtype=='mailer') width="190" @endif style="max-width:140px; object-fit: scale-down" @if($viewtype!='mailer')src="data:image/png;base64,{{$info['logo']}}" @else src="{{env('APP_URL')}}/uploads/images/logos/{{$info['image_path']}}" @endif  alt="">
                         @endif 
                   </div>
           </td>
           ...
           @endif
            @endforeach         
                ...
                <td style="text-align: left; padding: 2px">
                    <div style="height: 1px; width: 100%; background-color: #a9a9aa"></div>
                    ...
                    <div style="height: 1px;margin-top:5px; width: 100%; background-color: #a9a9aa"></div>
                </td>     
                @php
                $duename='Due Date';
                $duedt='';
            ...
            @endforeach
                <td style="text-align: center; padding: 2px">
                  ...
                  <td style="text-align: right; padding: 2px">
                    ...
                    <span style="padding: 2px; font-size: 18px; text-transform: uppercase"><span style="font-size: 14px;font-family:@if($info['currency_icon']=='₹')DejaVu Sans;@endif sans-serif;">{{$info['currency_icon']}}</span>{{$info['absolute_cost']}}</span>
                    <div style="height: 1px;margin-top:5px; width: 100%; background-color: #a9a9aa"></div>
                </td>
            </tr>            </table>
                    <table style="width: 100%" cellpadding="0" cellspacing="0" role="presentation">  
                                          <tr>
                                            <td style="padding: 2px">
                                                ...
                                                <div style="padding: 2px; font-size: 12px; color: #6b7280">{{$item['column_name']}}: <span style="font-family:@if($info['currency_icon']=='₹')DejaVu Sans;@endif sans-serif;">{{$info['currency_icon']}}</span>{{number_format($item['value'],2)}}</div> 
                                              
                                                @elseif($item['datatype']=='date')
                                                <div style="padding: 2px; font-size: 12px; color: #6b7280">{{$item['column_name']}}: <x-localize :date="$item['value']" type="date" /></div> 
                        ...
                        @endisset
                            ...
                            <thead>
                                <tr style="background-color: {{$info['design_color']}}; text-align: left; color: #000">
                                    ...
                                    <th style="min-width:60px;padding-left: 2px; padding-right: 2px; padding-top: 8px; padding-bottom: 8px; text-align:center; font-size: 14px; font-weight: 600; color: #fff">{{$item}} </th>
                                    @endforeach               
                                </tr>
                            </thead>
                            <tbody>
                    ...
                    <tr>
                        ...
                        <td style="min-width:60px;padding-top: 8px; padding-bottom: 8px;  text-align:center;  border-bottom: 1px solid {{$info['design_color']}};">

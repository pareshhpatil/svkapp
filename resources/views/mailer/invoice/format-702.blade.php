                                ...
                                <table style="width:100%">
                                    <tr>
                                        <td>
                                            @php
                                            $cper=0;
                                            if(($info['total_d']+$info['total_e']) <= 0){ $cper=0;} else{ $cper=round((($info['total_i']/($info['total_d']+$info['total_e']))*100));} $a5=0; $single_per=($info['total_d']+$info['total_e'])/100; $a5=$single_per*$cper; @endphp <div style="margin-top: 0px; font-size: 12px; font-weight: 700">5. RETAINAGE:
                </div>

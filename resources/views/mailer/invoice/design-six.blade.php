...
@endif
 @endforeach 
    <table style="width: 100%" cellpadding="0" cellspacing="0" role="presentation">
             ...
             <div style="margin-top: 16px; margin-bottom: 8px; text-align: right; font-weight: 700; letter-spacing: 0.1em; color: #000">{{$nm}} {{$inv}}</div>
           <table width="100%"> <td style="border-top: 2px solid rgb(228, 227, 227)"></td></table>
            ...
            <table style="margin-top: 16px; width: 100%" cellpadding="0" cellspacing="0" role="presentation">
                ...
                <td width="25%" style="vertical-align: top; text-align: left;padding-right: 10px;padding-top: 3px;">
                ...
                <td style=" padding: 2px; vertical-align: top;">
                    ...
                    <div style="margin-top: 4px; font-size: 14px; font-weight: 700">{{$metadata['header'][0]['value'] }}</div>
              ...
              <span style="font-size: 14px">{{$item['value'] }}</span><br>
              @endif
                @endforeach
              @foreach ($metadata['header'] as $item)
              ...
              <span style="font-size: 14px">{{$item['value'] }}</span><br>
                ...
                <td style=" padding: 2px; vertical-align: top;width: 36%;">
                    <div style="font-weight: 700; letter-spacing: 0.1em; color: #9ca3af">Client</div>
                    <span style="margin-top: 4px; font-size: 14px; font-weight: 700">{{$metadata['customer'][1]['value'] }}</span><br>
           ...
           <table width="100%"> <td style="border-top: 1px solid rgb(228, 227, 227); margin-top: 8px"></td></table>   
                     <table style="padding-top:5px;margin-top: 16px; width: 100%" cellpadding="0" cellspacing="0" role="presentation">
                <tr>
                    <td style="padding: 2px; vertical-align: top">
                        <table width="100%">
                 ...
                 <tr>
                    ...
                    <div style="font-size: 14px"><span style="font-size: 14px; text-transform: uppercase">{{$item['column_name']}}: </span><span style="font-family:@if($info['currency_icon']=='₹')DejaVu Sans;@endif sans-serif;">{{$info['currency_icon']}}</span>{{number_format($item['value'],2)}} </div>
                    @elseif($item['datatype']=='date')
                    <div style="font-size: 14px"><span style="font-size: 14px; text-transform: uppercase">{{$item['column_name']}}: </span><x-localize :date="$item['value']" type="date" /> </div>
                    @else
                    <div style="font-size: 14px"><span style="font-size: 14px; text-transform: uppercase">{{$item['column_name']}}: </span>{{$item['value']}} @if($item['datatype']=='percent') %@endif</div>
                 ...
                 <tr>
                  ...
                  <tr>
                    <td> <div style="font-size: 14px; font-weight: 700; text-transform: uppercase">Payment Method</div></td>
                    
                    <td><div style="font-size: 14px">{{$info['payment_mode']}}</div></td>
                </tr>
                @endisset
                @isset($info['transaction_id'])
                <tr>
                  <td> <div style="font-size: 14px; font-weight: 700; text-transform: uppercase">Transaction Number</div></td>
                 
                  <td> <div style="font-size: 14px">{{$info['transaction_id']}}</div></td>
              </tr>
              @endisset
            ...
            <table style="padding-top:5px;margin-left: auto; margin-right: auto; width: 100%;  background-color: #fff" cellpadding="0" cellspacing="0" role="presentation">
                <thead>
                    <tr>
                        @foreach ($table_heders as $item )
                        <th style="min-width:60px;border-bottom: 1px solid #374151 ;padding-left: 2px; padding-right: 2px; padding-top: 8px; padding-bottom: 8px; text-align:center; font-size: 14px; font-weight: 600; ">{{$item}} </th>
                        @endforeach               
                    </tr>
                </thead>
                <tbody>
            ...
            <td style="min-width:60px;padding-top: 8px; padding-bottom: 8px;  text-align:center; border-bottom: 1px solid #727272 ;">
                                     ...
                                     <td colspan="{{(count($table_heders)/2)-$addval}}"  style="vertical-align: top;">
                                        <table style="border-spacing: 0;width:100%;">
                                            <tr style="--tw-divide-y-reverse: 0; border-top-width: calc(1px * calc(1 - var(--tw-divide-y-reverse))); border-bottom-width: calc(1px * var(--tw-divide-y-reverse)); border-color: #e5e7eb">
                                                ...
                                                <td colspan="2" style="border-bottom: 1px solid #727272; padding-left: 8px; padding-right: 8px; padding-top: 8px; padding-bottom: 8px; text-align: left">
                                       <div style="flex: 1 1 0%; font-size: 14px; text-transform: uppercase; ">Sub Total</div>
                                    </td>
                                   <td style="border-bottom: 1px solid #727272; padding-left: 8px; padding-right: 8px; padding-top: 8px; padding-bottom: 8px; text-align: right">
                                       <div style="font-size: 14px; "><span style="font-family:@if($info['currency_icon']=='₹')DejaVu Sans;@endif sans-serif;">{{$info['currency_icon']}}</span>{{$info['basic_amount']}}</div>
                    ...
                    "> (Inclusive of tax)</div>
                      ...
                      @endisset
                                 ...
                                 <tr style="--tw-divide-y-reverse: 0; border-top-width: calc(1px * calc(1 - var(--tw-divide-y-reverse))); border-bottom-width: calc(1px * var(--tw-divide-y-reverse)); border-color: #e5e7eb">
                                   ...
                                   <td style="border-bottom: 1px solid #727272; padding-left: 8px; padding-right: 8px; padding-top: 8px; padding-bottom: 8px; text-align: right">
                                       <div style="font-size: 14px; "><span style="font-family:@if($info['currency_icon']=='₹')DejaVu Sans;@endif sans-serif;">{{$info['currency_icon']}}</span>{{$item['tax_amount']}}</div>
                                        </td>
                                        </tr>
                                        @php
                                 ...
                                 <tr style="--tw-divide-y-reverse: 0; border-top-width: calc(1px * calc(1 - var(--tw-divide-y-reverse))); border-bottom-width: calc(1px * var(--tw-divide-y-reverse)); border-color: #e5e7eb">
                                   ...
                                   <td style="border-bottom: 1px solid #727272;padding-left: 8px; padding-right: 8px; padding-top: 8px; padding-bottom: 8px; text-align: right">
                                       <div style="font-size: 14px; "><span style="font-family:@if($info['currency_icon']=='₹')DejaVu Sans;@endif sans-serif;">{{$info['currency_icon']}}</span>{{ number_format($total,2)}}</div>
                                        </td>                                      
                                       </tr>
                       ...
                       <td style="border-bottom: 1px solid #727272;padding-left: 8px; padding-right: 8px; padding-top: 8px; padding-bottom: 8px; text-align: right">
                       <div style="font-size: 14px; "><span style="font-family:@if($info['currency_icon']=='₹')DejaVu Sans;@endif sans-serif;">{{$info['currency_icon']}}</span>{{number_format($info['previous_due'],2)}}</div>
                       </td>                                      
                       </tr>
                       @endif
                       @endisset
                       ...
                       <td style="border-bottom: 1px solid #727272;padding-left: 8px; padding-right: 8px; padding-top: 8px; padding-bottom: 8px; text-align: right">
                       <div style="font-size: 14px; "><span style="font-family:@if($info['currency_icon']=='₹')DejaVu Sans;@endif sans-serif;">{{$info['currency_icon']}}</span>{{number_format($adjustment,2)}}</div>
                       </td>                                      
                       </tr>
                       @endif
                       @isset($info['advance'])
                       ...
                       <td style="border-bottom: 1px solid #727272;padding-left: 8px; padding-right: 8px; padding-top: 8px; padding-bottom: 8px; text-align: right">
                       <div style="font-size: 14px; "><span style="font-family:@if($info['currency_icon']=='₹')DejaVu Sans;@endif sans-serif;">{{$info['currency_icon']}}</span>{{number_format($info['advance'],2)}}</div>
                       </td>                                      
                       </tr>
                       @endif
                       @endisset
                       ...
                       <td style="border-bottom: 1px solid #727272;padding-left: 8px; padding-right: 8px; padding-top: 8px; padding-bottom: 8px; text-align: right">
                       <div style="font-size: 14px; "><span style="font-family:@if($info['currency_icon']=='₹')DejaVu Sans;@endif sans-serif;">{{$info['currency_icon']}}</span>{{number_format($info['paid_amount'],2)}}</div>
                       </td>                                      
                       </tr>
                       @endif
                       @endisset
                       ...
                       <td style="border-bottom: 1px solid #727272;padding-left: 8px; padding-right: 8px; padding-top: 8px; padding-bottom: 8px; text-align: right">
                       <div style="font-size: 14px; "><span style="font-family:@if($info['currency_icon']=='₹')DejaVu Sans;@endif sans-serif;">{{$info['currency_icon']}}</span>{{number_format($info['late_fee'],2)}}</div>
                       </td>                                      
                       </tr>
                       @endif
                       @endisset
                       ...
                       <td style="border-bottom: 1px solid #727272;padding-left: 8px; padding-right: 8px; padding-top: 8px; padding-bottom: 8px; text-align: right">
                       <div style="font-size: 14px; "><span style="font-family:@if($info['currency_icon']=='₹')DejaVu Sans;@endif sans-serif;">{{$info['currency_icon']}}</span>{{number_format($info['absolute_cost'],2)}}</div>
                       </td>                                      
                       </tr>
                       @endif
                       <tr style="--tw-divide-y-reverse: 0; border-top-width: calc(1px * calc(1 - var(--tw-divide-y-reverse))); border-bottom-width: calc(1px * var(--tw-divide-y-reverse)); border-color: #e5e7eb">
                           <td colspan="2" style="border-left: 1px solid #727272;background-color:#c9c9c9;border-bottom: 1px solid #727272;padding-left: 8px; padding-right: 8px; padding-top: 8px; padding-bottom: 8px; text-align: left">
                           <div style="flex: 1 1 0%; font-size: 14px; text-transform: uppercase; color: #080808"> Amount Due</div>
                           </td>
                           <td style="background-color:#c9c9c9;border-bottom: 1px solid #727272;border-right: 1px solid #727272;padding-left: 8px; padding-right: 8px; padding-top: 8px; padding-bottom: 8px; text-align: right">
                           <div style="font-size: 14px; color: #080808"><span style="font-family:@if($info['currency_icon']=='₹')DejaVu Sans;@endif sans-serif;">{{$info['currency_icon']}}</span>{{number_format($info['absolute_cost'],2)}}</div>
                           </td>                                      
                           </tr>
                       <tr style="--tw-divide-y-reverse: 0; border-top-width: calc(1px * calc(1 - var(--tw-divide-y-reverse))); border-bottom-width: calc(1px * var(--tw-divide-y-reverse)); border-color: #e5e7eb">

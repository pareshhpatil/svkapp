...
<body style="min-width:380px;word-break: break-word; -webkit-font-smoothing: antialiased; margin: 0; width: 100%; padding: 0">
    ...
    <div role="article" aria-roledescription="email" aria-label="" lang="en">    
        <table style="width: 100%" cellpadding="0" cellspacing="0" role="presentation">
            ...
            <img @if($viewtype=='mailer') width="190" @endif  @if($viewtype!='mailer')src="data:image/png;base64,{{$info['logo']}}" @else src="{{env('APP_URL')}}/uploads/images/logos/{{$info['image_path']}}" @endif style=" object-fit: scale-down;max-width:140px" alt="">
             ...
             <td style="padding: 2px; vertical-align: top" colspan="2">
                ...
                <div style="margin-top: 4px; font-size: 14px; font-weight: 600">{{$metadata['header'][0]['value'] }}</div>
          ...
          @endif
            ...
            @endforeach
                                ...
                                <table width="100%"><td style="border-top: 2px solid {{$info['design_color']}}; margin-top: 10px; margin-bottom: 10px; width: 100%"></td></table>
                                                  <table style="width: 100%" cellpadding="0" cellspacing="0" role="presentation">
                ...
                <td style="padding: 2px; vertical-align: top"> 
                    <div style="padding-top:4px;padding-bottom:4px;font-size: 14px; font-weight: 700; text-transform: uppercase">Client</div>
             
                    <div style="font-size: 14px">{{$metadata['customer'][1]['value'] }}</div>
                ...
                <td style="padding: 2px; vertical-align: top">
                    ...
                    <tr>
                        <td><div style="font-size: 14px; font-weight: 700; text-transform: uppercase">{{$item['column_name']}}</div></td>
                        <td style="padding:5px;"> </td>
                        <td>  <div style="font-size: 14px">{{$item['value']}}</div>  </td>
                    </tr>
                        @endif
                        @endforeach
             ...
             <tr>
                ...
                <div style="font-size: 14px"><span style="font-family:@if($info['currency_icon']=='₹')DejaVu Sans;@endif sans-serif;">{{$info['currency_icon']}}</span>{{number_format($item['value'],2)}} </div>
                @elseif($item['datatype']=='date')
                <div style="font-size: 14px"><x-localize :date="$item['value']" type="date" /> </div>
                @else
                <div style="font-size: 14px">{{$item['value']}} @if($item['datatype']=='percent') %@endif</div>
        ...
        <table width="100%">
            <td  style="border-top: 2px solid {{$info['design_color']}};  width: 100%"></td> </table>
                ...
                @if (!empty($table_heders))
                    <table style="margin-left: auto; margin-right: auto; width: 100%;  background-color: #fff" cellpadding="0" cellspacing="0" role="presentation">
                        <thead>
                            <tr style="background-color: {{$info['design_color']}};">
                                @foreach ($table_heders as $item )
                                <th style="min-width:60px;border:1px solid {{$info['design_color']}};padding-left: 2px; padding-right: 2px; padding-top: 8px; padding-bottom: 8px;  text-align:center; font-size: 14px; font-weight: 600; color:white;">{{$item}} </th>
                                @endforeach               
                            </tr>
                        </thead>
                        <tbody>
                    ...
                    <td style="min-width:60px;padding-left: 5px;padding-top: 8px; padding-bottom: 8px;  text-align:center; border: 1px solid {{$info['design_color']}};">
                        ...
                        @endphp
                         ...
                         @endphp
                            <tr style="--tw-divide-y-reverse: 0; border-top-width: calc(1px * calc(1 - var(--tw-divide-y-reverse))); border-bottom-width: calc(1px * var(--tw-divide-y-reverse)); border-color: #e5e7eb">
                              ...
                              @endif
                              <tr style="--tw-divide-y-reverse: 0; border-top-width: calc(1px * calc(1 - var(--tw-divide-y-reverse))); border-bottom-width: calc(1px * var(--tw-divide-y-reverse)); border-color: #e5e7eb">
                                  <td colspan="2" style="background-color:{{$info['design_color']}};border-bottom: 2px solid {{$info['design_color']}};padding-left: 8px; padding-right: 8px; padding-top: 8px; padding-bottom: 8px; text-align: left">
                                  <div style="flex: 1 1 0%; font-size: 14px; text-transform: uppercase; color: white"> Amount Due</div>
                                  </td>

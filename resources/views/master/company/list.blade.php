                ...
                <table id="example1" class="table table-bordered table-striped">
                    ...
                    <tbody>
                        ...
                        <tr class="odd gradeX">
                            ...
                            <td>
                                <a href="/admin/company/view/{{$item->link}}" class="btn btn-xs btn-primary"><i class="fa fa-table"></i></a>
                                <a href="/admin/company/update/{{$item->link}}" class="btn btn-xs btn-success"><i class="fa fa-edit"></i></a>

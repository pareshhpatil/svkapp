                ...
                <form ref="form" action="/profile/save" method="post">
                    ...
                    <div class="form-group basic">
                        <div class="input-wrapper">
                            ...
                            <input type="text" class="form-control" readonly :onclick="updated=true" name="name" v-model="data.name" placeholder="Enter your name">
                        </div>
                    </div>
                    <div class="form-group basic">
                        <div class="input-wrapper">
                    ...
                    <div class="form-group basic">
                        <div class="input-wrapper">
                            ...
                            <input type="text" class="form-control" readonly :onclick="updated=true" name="email" v-model="data.email" placeholder="Enter your email">
                        </div>
                    </div>
                    ...
                    <div class="form-group basic">
                        <div class="input-wrapper">
                            ...
                            <input type="text" readonly class="form-control" :onclick="updated=true" name="emergency_contact" v-model="data.emergency_contact" placeholder="Enter emergency contact">
                        </div>
                    </div>
                    <div class="form-group basic">
                        <div class="input-wrapper">
        ...
        methods: {
            ...
            crop() {
                ...
                this.$refs.croppieRef.result(options, output => {
                    ...
                    axios.post('/upload/file/image/{{$id}}', formData, config)

                    ...
                    <div class="">
                        <table class="table" style="font-size: 12px !important;color: black !important;margin-bottom: 0;">
                            <tbody>
                                ...
                                <tr>
                                    <td class="td-c text-red" style="border-top: 0px;font-size: 20px;font-family: cambria;color: #ff0000;padding-bottom: 10px;padding-top: 10px;">
                                    SIDDHIVINAYAK TRAVELS HOUSE
                                </td>
                                </tr>
                                <tr>
                                    <td class="td-c" style="font-size: 15px;font-family: cambria;  border-top: 2px solid #4F81BD;padding-top: 10px;">

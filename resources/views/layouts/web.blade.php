        ...
        <div class="layout-container">
            ...
            <aside id="layout-menu" class="layout-menu menu-vertical menu bg-menu-theme">
                <div class="app-brand demo">
                    <a href="#" class="app-brand-link">
                        <span class="app-brand-logo demo" style="height: 60px;width: 97%;">
                            <img style="max-width: 100%;" src="https://siddhivinayaktravel.in/dist/img/1681581649.png">
                        </span>
                    </a>
                ...
                <ul class="menu-inner py-1">
                    ...
                    <li class="menu-item @if(in_array($row['id'], $selectedMenu)) active open @endif">
                        <a href="@if ($row['link']!=''){{$row['link']}} @else javascript:; @endif" class="menu-link @if($row['link']=='') menu-toggle @endif">
                            <i class="menu-icon tf-icons ti {{$row['icon']}}"></i>
                            <div data-i18n="{{$row['title']}}">{{$row['title']}}</div>
                        </a>
                        @isset($menus[$row['id']])
                        <ul class="menu-sub">
                            @foreach ($menus[$row['id']] as $row2)
                            <li class="menu-item @if(in_array($row2['id'], $selectedMenu)) active open @endif">
                                <a href="@if ($row2['link']!=''){{$row2['link']}} @else javascript:; @endif" class="menu-link ">

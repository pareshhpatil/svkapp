...
<div class="row" id="insert">
    <form action="/employee/formsave" method="post" id="customerForm" enctype="multipart/form-data" class="form-horizontal">
        ...
        <div class="col-md-6">
            ...
            <div class="form-group">
                ...
                <div class="col-md-7">
                    <input type="text" name="join_date" value="08-01-2018" required="" autocomplete="off" class="form-control form-control-inline date-picker" data-date-format="yyyy-mm-dd">
                </div>
            </div>
            <div class="form-group">

...
<div class="row">
    <div class="col-lg-12">
        ...
        <div class="panel panel-primary" style="display: none;" id="insert">
            <div class="panel-body" style="overflow: auto;">
                <div class="row"  >
                    <form action="/admin/employee/saveadvance" method="post"  enctype="multipart/form-data" class="form-horizontal">
                        ...
                        <div class="col-md-6">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-md-7">
                                    <input type="text" id="remark" required="" name="remark"   class="form-control" >
                                </div>
                            </div>

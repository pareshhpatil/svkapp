                            ...
                            <table class="table table-bordered" style="font-size: 12px !important;color: black !important;">
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td class="td-c"><input type="text"  class="form-control"  name="qty[]" value="{{$det['qty']}}"></td>
                                        <td class="td-c"><input type="text" class="form-control"  name="rate[]" value="{{$det['rate']}}"></td>
                                        <td class="td-c"><input type="number" step="0.01" class="form-control" id="amt{{$int}}" name="amount[]" onblur="calculateIdeaLogsheet();" name="amount[]" value="{{$det['amount']}}">
                                    ...
                                    <tr>
                                        ...
                                        <td><span class="pull-right"><input id="cgst" class="form-control" type="number" onblur="calculateIdeaLogsheet();" step="0.01" value="2.50"></span></td>
                                    ...
                                    <tr>
                                        ...
                                        <td><span class="pull-right"><input id="sgst" class="form-control" onblur="calculateIdeaLogsheet();" type="number" step="0.01" value="2.50"></span></td>
                                    ...
                                    <tr>
                                        ...
                                        <td><span class="pull-right"><input id="igst" class="form-control" onblur="calculateIdeaLogsheet();" type="number" step="0.01" value="0.0"></span></td>

...
<section class="jumbotron jumbotron-features bg-transparent py-5" id="header">
    <div class="container">
        <div class="row">
            ...
            <!-- end -->
            <div class="col-md-6">
                <h2>Proud to partner with {{$title}}</h2>
                <p>{{$title}} and Swipez have partnered to digitize your business operations via a cloud based billing solution.
                </p>
            ...
            <div class="col-md-6 center-text">
                <img style="max-width: 50%;" src="{{$partner_logo}}"/>
                <h5 class="center-text mt-2">Save over ₹5 lacs a year in accounting efficiency
                </h5>

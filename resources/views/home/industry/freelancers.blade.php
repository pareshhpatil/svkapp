    ...
    <div class="container">
        <div class="row align-items-center">
            <div class="col-12 col-md-12 col-lg-6 col-xl-5">
                <h1>Billing software for consultancy firms and freelancers</h1>
                <p class="lead mb-5">Spend less time chasing payments, focus on growing your business. Enabling timely
                    revenue collections for your hard work.</p>
            ...
            <div class="col-12 col-md-8 m-auto ml-lg-auto mr-lg-0 col-lg-6 pt-5 pt-lg-0">
                <img alt="image" class="img-fluid"
                    src="{!! asset('images/product/billing-software/industry/freelancer.svg') !!}" />
            </div>
        </div>
    </div>
</section>
<section class="jumbotron py-5 bg-secondary text-white" id="cta">
    <div class="container">
        <div class="row text-center">
            <div class="col-md-12">
                <h2>Organising billing and collections for consultancy firms and freelancers.</h2>
            </div>
        </div>
    </div>
</section>
<section class="jumbotron py-5 bg-transparent" id="steps">
    <div class="container">
        <h2 class="text-center pb-5">Benefits of using <a href="{{ route('home.billing') }}">billing software</a> for
            freelancers</h2>
        <p class="text-center lead">Swipez billing software for consulting firms helps reduce the burden by automating
            these basic yet important business operations.</p>
        <div class="container py-2">
            <div class="row no-gutters pb-5">
                ...
                <div class="col-sm py-2">
                    <div class="card card-border-none">
                        <div class="card-body">
                            <h2 class="card-title">Get paid faster using Swipez’s online billing software for
                                freelancers and consulting firms</h2>
                            <p class="card-text">A smooth cash flow is a boon as a freelance professional. Making it
                                easier for you to send out invoices and for your clients to make a payment ensures you
                                get paid on time and with as little hassle as possible. The Swipez GST billing software
                                for freelancers lets you send out invoices electronically thus reducing the delay in
                                delivery. Know when an invoice is viewed, becomes due, or gets paid, so you can stay on
                                top of your cash flow better than ever. Once delivered your clients have the choice to
                                make payments using numerous payment modes. All these factors contribute to hurdling
                                payment barriers and getting you paid on time.</p>
                        </div>
                    </div>
                </div>
            </div>
            <div class="row no-gutters pb-5">
                <div class="col-sm py-2">
                    <div class="card d-none d-sm-flex card-border-none">
                        <div class="card-body">
                            <h2 class="card-title">Professional design</h2>
                            <p class="card-text">Professionally designed invoices and estimates go a long way to making
                                a good impression with your clients and prospects. Brand identity and continuity is key
                                to establishing a successful consultancy business. The Swipez billing software for
                                consulting firms has out of the box customisable invoice formats which standardise your
                                invoicing flow and bring a touch of professionalism to your operations. </p>
                        </div>
                    </div>
                    <!-- for iPad and mobile -->
            ...
            <div class="row no-gutters pb-5">
                ...
                <div class="col-sm py-2">
                    <div class="card card-border-none">
                        <div class="card-body">
                            <h2 class="card-title">Automate recurring payments with Swipez’s fast and efficient billing
                                software for freelancers and consultancy firms</h2>
                            <p class="card-text">Having clients that are billed on a retainer basis is a key for
                                consultancy firms / freelancers to be able to predict their revenue and plan future
                                growth. However collecting these payments is a time consuming task as invoices have to
                                be generated diligently, delivered efficiently and need to be followed up for payments.
                                The Swipez consultancy firms billing software lets you setup subscription billing and
                                your customers will receive your bills automatically at a set frequency every month.</p>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="row no-gutters pb-5">
                <div class="col-sm py-2">
                    <div class="card d-none d-sm-flex card-border-none">
                        <div class="card-body">
                            <h2 class="card-title">Reduced payment related follow ups and save time using Swipez’s
                                billing software for freelancers and consulting firms </h2>
                            <p class="card-text">Sending out an invoice is just the first part in the payment struggle.
                                Once an invoice is sent you need to vigorously follow up to ensure timely payment. This
                                process is taxing on a consultancy or freelance business. Swipez’s billing software for
                                consulting firms lets you automate and customise a reminder schedule for each invoice,
                                making sure that your client never overlooks a payment. </p>
                        </div>
                    </div>
                    <!-- for iPad and mobile -->
                    <div class="card card-border-none d-sm-none">
            ...
            <div class="row no-gutters pb-5">
                ...
                <div class="col-sm py-2">
                    <div class="card card-border-none">
                        <div class="card-body">
                            <h2 class="card-title">Carry out business operation on the go with Swipez’s freelancers
                                billing software</h2>
                            <p class="card-text">The Swipez billing software for freelancers allows you to create and
                                send invoices from anywhere as long as you have an internet connection. Your complete
                                billing process can be handled from out of office. All your data and templates are
                                securely stored and can be accessed from any device or computer. This freedom allows you
                                to focus on growing your business but still manage your business operations</p>
                        </div>
                    </div>
                </div>
                ...
                <div class="bg-secondary rounded-1 p-5">
                    <div class="row text-white">
                        <div class="col-md-6 px-3 d-none d-lg-block">
                            <h2 class="pb-3">
                                <b>Download invoice format for consultants and freelancers</b>
                            </h2>
                            <ul class="list-unstyled">
                                ...
                                <li class="lead text-white">
                                    ...
                                    Invoices as per freelancer industry formats
                                </li>
                                <li class="lead text-white">
                                    <svg aria-hidden="true" focusable="false" data-prefix="fas" data-icon="check"
                                        class="h-6 pr-1" role="img" xmlns="http://www.w3.org/2000/svg"
                            ...
                            <a class="btn btn-info big-text" href="{{ route('home.consultantinvoiceformat') }}">Download
                                invoice format</a>
                        </div>
...
<section class="jumbotron py-4 bg-white" id="features">
    <div class="container">
        ...
        <div class="row row-eq-height text-center pb-5">
            <div class="col-md-4">
                <div class="bg-light-blue p-4 h-100">
                    <svg aria-hidden="true" focusable="false" data-prefix="fas" data-icon="smile-beam"
                        class="h-16 text-secondary pb-2" role="img" xmlns="http://www.w3.org/2000/svg"
                        viewBox="0 0 496 512">
                        <path fill="currentColor"
                    ...
                    <p>Send custom coupons to customers. Notify customers of new services via SMS. Provide your
                        customers coupons & offers from the online largest brands.</p>
                </div>
            </div>
            <div class="col-md-4">
                <div class="bg-light-blue p-4 h-100">
                    <svg aria-hidden="true" focusable="false" data-prefix="fas" data-icon="percent"
                        class="h-16 text-secondary pb-2" role="img" xmlns="http://www.w3.org/2000/svg"
                        viewBox="0 0 448 512">
                        <path fill="currentColor"
    ...
    <div class="container">
        <div class="row text-center">
            <div class="col-md-12 mb-5">
                <h3 class="text-white">{{env('SWIPEZ_BIZ_NUM')}} small and medium business owners use Swipez
                    billing<br /><br />Get your account, its free!</h3>
            </div>
        ...
        <div class="zig">
            <div class="row">
                <div class="col-sm-12 col-md-12 col-lg-7 col-xl-7">
                    <h2 class="section_title">Advantages of using Swipez billing software for freelancers</h2>
                    <p class="intro-description">Key advantages freelancers gain using our <a
                    ...
                    <div class="step mt-5">
                        ...
                        <div>
                            ...
                            <p>Delays due to cheque and cash payments reduced by over 60%</p>
                        </div>
                    </div>
                    <div class="step">
                        <div>
                        ...
                        <div>
                            <h3>Calls reduced</h3>
                            <p>Follow up calls for payments reduced by over 40%</p>
                        </div>
                    </div>
                    <div class="step">
                        <div>

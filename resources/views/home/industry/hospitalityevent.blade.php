    ...
    <div class="container">
        <div class="row align-items-center">
            <div class="col-12 col-md-12 col-lg-6 col-xl-5">
                <h1>Event registration and bookings for hospitality events</h1>
                <p class="lead mb-5">Create beautiful landing pages for your hospitality event and let your customers
                    book and pay online.</p>
                @include('home.product.web_register',['d_type' => "web"])
            </div>
            <div class="col-12 col-md-8 m-auto ml-lg-auto mr-lg-0 col-lg-6 pt-5 pt-lg-0">
                <img alt="Event registration and bookings for hospitality events" class="img-fluid"
                     src="{!! asset('images/product/event-registration/industry/hospitality.svg') !!}" />
            </div>
        </div>
    </div>
</section>
<section class="jumbotron py-5 bg-secondary text-white" id="cta">
    <div class="container">
        <div class="row text-center">
            <div class="col-md-12">
                <h2>Swipez event registration software for hospitality events</h2>
            </div>
        </div>
    </div>
</section>
<section class="jumbotron py-5 bg-transparent" id="steps">
    <div class="container">
        <h2 class="text-center pb-5">Benefits of using the Swipez <a href="{{ route('home.event') }}">event registration software</a> for hospitality events</h2>
        <p class="text-center lead">Swipez event registration software for hospitality events assists you in creating and managing your event online effortlessly. </p>
        <div class="container py-2">
            <div class="row no-gutters pb-5">
                ...
                <div class="col-sm py-2">
                    <div class="card card-border-none">
                        <div class="card-body">
                            <h2 class="card-title">No revenue share for tickets sold with the Swipez event management software for hospitality venues                             </h2>
            ...
            <div class="row no-gutters pb-5">
                <div class="col-sm py-2">
                    <div class="card d-none d-sm-flex card-border-none">
                        <div class="card-body">
                            <h2 class="card-title">Own your customer relationships using our with free event registration software for hospitality venues                            </h2>
                            <p class="card-text">Building relationships with customers and keeping them aware of upcoming events is key to running successful events. The Swipez event registration software for entertainment events gives you free access to all the booking information of your patrons, use customer data from all your past events to target promotion of future events.</p>
                        </div>
                    </div>
                    <!-- for iPad and mobile -->
            ...
            <div class="row no-gutters pb-5">
                ...
                <div class="col-sm py-2">
                    <div class="card card-border-none">
                        <div class="card-body">
                            <h2 class="card-title">Better on the day execution using our hassle free hospitality event booking software  </h2>
                            <p class="card-text">Getting an exact headcount of bookings for your event is crucial to the setup of an event at hospitality venues. It lets you efficiently utilise your space and setup for the day of the event.
                            </p>
                        </div>
                    </div>
                </div>
    ...
    <div class="container">
        <div class="row text-center">
            <div class="col-md-12 mb-5">
                <h3 class="text-white">Over {{env('SWIPEZ_BIZ_NUM')}} businesses use Swipez for event management & billing everyday!<br /><br />Register to get your free account</h3>
            </div>
        ...
        <div class="row row-eq-height text-center pb-5">
            <div class="col-md-4">
                <div class="bg-light-blue p-4 h-100">
                    ...
                    <p>Set up seats and packages easily. People are intimated upon booking and cancellation of seats.</p>
                </div>
            </div>
            <div class="col-md-4">
                <div class="bg-light-blue p-4 h-100">
            ...
            <div class="col-md-4">
                <div class="bg-light-blue p-4 h-100">
                    ...
                    <p>Lowest in industry online transaction rates help you earn more revenue. No share taken for every
                        ticket sold.</p>
                </div>
            </div>
        </div>
        <div class="row row-eq-height text-center pb-5">
            <div class="col-md-4">
                <div class="bg-light-blue p-4 h-100">
                    ...
                    <p>Customers receive QR code post booking. Use our QR code reader to manage box entries smoothly.</p>
                </div>
            </div>
            <div class="col-md-4">
                <div class="bg-light-blue p-4 h-100">
            ...
            <div class="col-md-4">
                <div class="bg-light-blue p-4 h-100">
                    ...
                    <p>Collect customer data from your events. Use collected customer data to target for future events with
                        ease.</p>
                </div>
            </div>
        </div>
        ...
        <div class="zig">
            <div class="row">
                <div class="col-sm-12 col-md-12 col-lg-7 col-xl-7">
                    <h2 class="section_title">Advantages of using <a href="{{ route('home.event') }}">free event registration software</a> for hospitality events</h2>
                    <p class="intro-description">Key advantages hospitality companies have seen using Swipez event registration platform</p>
                    <div class="step mt-5">
                        <div>
                        ...
                        <div>
                            <h3>Save revenue</h3>
                            <p>Earned 18-20% more revenue compared to selling the same tickets on other event booking platforms</p>
                        </div>
                    </div>
                    <div class="step">
                        <div>

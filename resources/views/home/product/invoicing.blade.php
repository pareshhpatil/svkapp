    ...
    <div class="container">
        <div class="row align-items-center">
            <div class="col-12 col-md-12 col-lg-6 col-xl-5 d-none d-lg-block">
                ...
                <p class="lead mb-2">Automate error-free GST invoicing to suit your business needs. Ensure prompt
                    payment collections for both domestic and international customers. Fast-track your business with the
                    best in online invoicing solutions. </p>
            ...
            <div class="col-12 col-md-8 m-auto ml-lg-auto mr-lg-0 col-lg-6 pt-5 pt-lg-0 d-none d-lg-block">
                <img alt="Simplified GST einvoicing for businesses" class="img-fluid"
                    src="{!! asset('images/product/einvoicing-software.svg') !!}" />
            </div>
            <!-- for iPad and mobile -->
            <div class="col-12 d-lg-none text-center">
                <img alt="Simplified GST einvoicing for businesses" class="img-fluid mb-5"
                    src="{!! asset('images/product/einvoicing-software.svg') !!}" />
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-4 col-xs-4 d-flex align-items-stretch">
                                            <div class="card d-flex flex-column">
                                                <h2 class="gray-600 plugin-p"><strong>Easy to customize invoice
                                                        templates</strong></h2>
                                                <img class="card-img-top p-2 mt-4"
                                                    src="{!! asset('/images/product/online-invoicing/features/customize-invoice.svg') !!}"
                                                    alt="Customizable invoice look and feel" width="100%" height="200px"
                                                    loading="lazy" class="lazyload" />
                                                <div class="container">

                                                    <p class="lead pstyle">Personalize industry-approved invoice
                                                        templates to reflect your brand image and suit your business
                                                        needs. Choose from a range of GST-compliant invoice templates to suit your needs. Designed for different industries like utility providers, tour & travel operators, freelancers & more. </p>
                                                </div>
                                            </div>
                                        ...
                                        <div class="col-md-4 col-xs-4 d-flex align-items-stretch">
                                            <div class="card d-flex flex-column">
                                                <h2 class="gray-600 plugin-p"><strong>Manage customer data for easy
                                                        invoicing</strong></h2>
                                                <img class=" card-img-top p-2 mt-4"
                                                    src="{!! asset('/images/product/online-invoicing/features/manage-customer-data.svg') !!}"
                                                    alt="Manage customer data" width="100%" height="200px"
                                                    loading="lazy" class="lazyload" />
                                                <div class="container">

                                                    <p class="lead pstyle">Automate customer data management with
                                                        invoicing. Add a unique customer code to your invoices either
                                                        automatically or manually. Manage customer details like contact
                                                        information, company information, GST details & more with
                                                        configurable customer database fields.</p>
                                                </div>
                                            </div>
                                        ...
                                        <div class="col-md-4 col-xs-4 d-flex align-items-stretch">
                                            <div class="card d-flex flex-column">
                                                <h2 class="gray-600 plugin-p"><strong>Accurate GST calculations for
                                                        invoices</strong></h2>
                                                <img class=" card-img-top p-2 mt-4"
                                                    src="{!! asset('/images/product/online-invoicing/features/invoicing-with-gst-calculator.svg') !!}" alt="Calculate GST in invoices" width="100%" height="200px" loading="lazy" class="lazyload" />
                                <div class="container">
            ...
            <div class="row">
                <div class="col-md-4 col-xs-4 d-flex align-items-stretch">
                    <div class="card d-flex flex-column">
                       <h2 class="gray-600 plugin-p" ><strong>Multiple payment options</strong></h2>
                        <img class=" card-img-top p-2 mt-4"
                        src="{!! asset('/images/product/online-invoicing/features/multiple-payment-options.svg')!!}"
                                                    alt="Invoicing with online payments" width="100%" height="200px"
                                                    loading="lazy" class="lazyload" />
                                                <div class="container">

                                                    <p class="lead pstyle">Collect payments directly from your invoices
                                                        via multiple modes like UPI, Debit card, Credit card, Net
                                                        banking, eWallets & more. Receive prompt domestic and
                                                        international payments directly in your company bank account
                                                        with seamless payment gateway integration.</p>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="col-md-4 col-xs-4 d-flex align-items-stretch">
                                            <div class="card d-flex flex-column">
                                                ...
                                                <img class=" card-img-top p-2 mt-4"
                                                    src="{!! asset('/images/product/online-invoicing/features/inventory-management.svg') !!}"
                                                    alt="Invoicing with inventory management" width="100%"
                                                    height="200px" loading="lazy" class="lazyload" />
                                                <div class="container">

                                                    <p class="lead pstyle">Automatically reduce stocks or product
                                                        quantity as you raise invoices. Manage different
                                                        products/services with a variety of features. Add product
                                                        number, cost price, sale price, maximum retail price (MRP),
                                                        expiry date, discounts, applicable HSN/SAC code & more. </p>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="col-md-4 col-xs-4 d-flex align-items-stretch">
                                            <div class="card d-flex flex-column">
                                                <h2 class="gray-600 plugin-p"><strong>Automated payment
                                                        notifications</strong></h2>
                                                <img class=" card-img-top p-2 mt-4"
                                                    src="{!! asset('/images/product/online-invoicing/features/payment-notifications.svg') !!}"
                                                    alt="Automated payment notifications" width="100%" height="200px"
                                                    loading="lazy" class="lazyload" />
                                                <div class="container">

                                                    <p class="lead pstyle">Automate payment reminders with online <a
                                                            href="{{ config('app.APP_URL') }}payment-link">payment
                                                            links</a> to ensure prompt payments. Customize the frequency
                                                        of reminders, notification text, and more as per your
                                                        requirements. Send automated payment reminders to customers with
                                                        overdue invoices via email and/or SMS. </p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="row">
                                        <div class="col-md-4 col-xs-4 d-flex align-items-stretch">
                                            <div class="card d-flex flex-column">
                                                ...
                                                <img class=" card-img-top p-2 mt-4"
                                                    src="{!! asset('/images/product/online-invoicing/features/recurring-invoices.svg') !!}" alt="Create and send recurring invoices" width="100%" height="200px" loading="lazy" class="lazyload" />
                        <div class="container">
                ...
                <div class="col-md-4 col-xs-4 d-flex align-items-stretch">
                    <div class="card d-flex flex-column">
                        ...
                        <img class=" card-img-top p-2 mt-4" src="{!! asset('/images/product/online-invoicing/features/bulk-invoicing.svg')
                                                    !!}" alt="Bulk invoicing using excel uploads or APIs" width="100%" height="200px"
                                                    loading="lazy" class="lazyload" />
                                                <div class="container">

                                                    <p class="lead pstyle">Create and send invoices in bulk with easy
                                                        excel uploads and/or APIs. Auto-generate and deliver invoices in
                                                        bulk to your customer base via email & SMS with online payment
                                                        options. Automate bulk invoicing for recurring invoices with
                                                        easy-to-create subscriptions. </p>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="col-md-4 col-xs-4 d-flex align-items-stretch">
                                            <div class="card d-flex flex-column">
                                                ...
                                                <img class=" card-img-top p-2 mt-4"
                                                    src="{!! asset('/images/product/online-invoicing/features/einvoicing.svg') !!}"
                                                    alt="E-invoicing online" width="100%" height="200px"
                                                    loading="lazy" class="lazyload" />
                                                <div class="container">
                                                    <p class="lead pstyle">Create GST-compliant e-invoices and submit
                                                        them directly to the Invoice Registration Portal (IRP). Add a
                                                        unique Invoice Reference Number (IRN) and a QR code before
                                                        sending them to your customers. Ensure error-free GST filing and
                                                        reconciliation with e-invoicing.</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                ...
                                <div class="item">
                                    <div class="row">
                                        ...
                                        <div class="col-md-4 col-xs-4 d-flex align-items-stretch">
                                            <div class="card d-flex flex-column">
                                                <h2 class="gray-600 plugin-p"><strong>Plugins to automate invoicing</strong></h2>
                                                <img class=" card-img-top p-2 mt-4"
                                                    src="{!! asset('/images/product/online-invoicing/features/automate-invoicing-with-plugins.svg') !!}"
                                                    alt="Plugins to automate invoicing" width="100%" height="200px"
                                                    loading="lazy" class="lazyload" />
                                                <div class="container">

                                                    <p class="lead pstyle">Add discount coupons, attach files, enable
                                                        auto collection of payments, and more with plugins to customize
                                                        your invoice. Create invoices for franchise, notify suppliers,
                                                        calculate previous dues & more. Enable/disable plugins to ease
                                                        billing & payment collections.</p>
                                                </div>
                                            </div>
                                        ...
                                        <div class="col-md-4 col-xs-4 d-flex align-items-stretch">
                                            <div class="card d-flex flex-column">
                                                <h2 class="gray-600 plugin-p"><strong>Automatically convert estimates to
                                                        invoices</strong></h2>
                                                <img class=" card-img-top p-2 mt-4"
                                                    src="{!! asset('/images/product/online-invoicing/features/convert-estimates-to-invoicing.svg') !!}"
                                                    alt="Convert estimates to invoicing" width="100%" height="200px"
                                                    loading="lazy" class="lazyload" />
                                                <div class="container">

                                                    <p class="lead pstyle"> Estimates created & sent to your customers
                                                        include an online payment option. Once an estimate is paid, it
                                                        can easily be converted to an invoice. Either automatically or
                                                        manually as per your needs. Ensure error-free invoicing with
                                                        easy conversions for estimates.
                                                    </p>
                                                </div>
                                            </div>
                        ...
                        <div class="carousel slide" id="theCarousel1" data-ride="carousel">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-4 col-xs-12 d-flex align-items-stretch">
                                            <div class="card d-flex flex-column">
                                                ...
                                                <img class="card-img-top p-2 mt-4"
                                                    src="{!! asset('/images/product/online-invoicing/features/customize-invoice.svg') !!}"
                                                    alt="Create invoices or estimates" width="100%" height="200px"
                                                    loading="lazy" class="lazyload" />
                                                <div class="container">
                                        ...
                                        <div class="col-md-4 col-xs-12 d-flex align-items-stretch">
                                            <div class="card d-flex flex-column">
                                                <h2 class="gray-600 plugin-p"><strong>Accurate GST calculations for
                                                        invoices</strong></h2>
                                                <img class=" card-img-top p-2 mt-4"
                                                    src="{!! asset('/images/product/online-invoicing/features/invoicing-with-gst-calculator.svg') !!}" alt="Create invoices or estimates" width="100%" height="200px" loading="lazy" class="lazyload" />
                                                    <div class="container">
                              ...
                              <div class="item">
                                <div class="row">
                                    ...
                                    <div class="col-md-4 col-xs-12 d-flex align-items-stretch">
                                        <div class="card d-flex flex-column">
                                           <h2 class="gray-600 plugin-p" ><strong>Multiple payment options</strong></h2>
                                            <img class=" card-img-top p-2 mt-4" src="{!! asset('/images/product/online-invoicing/features/multiple-payment-options.svg')
                                                    !!}" alt="Create invoices or estimates" width="100%" height="200px"
                                                    loading="lazy" class="lazyload" />
                                                <div class="container">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-4 col-xs-12 d-flex align-items-stretch">
                                            <div class="card d-flex flex-column">
                                                <h2 class="gray-600 plugin-p"><strong>Recurring invoicing</strong></h2>
                                                <img class=" card-img-top p-2 mt-4"
                                                    src="{!! asset('/images/product/online-invoicing/features/recurring-invoices.svg') !!}" alt="Create invoices or estimates" width="100%" height="200px" loading="lazy" class="lazyload" />
                                            <div class="container">
                                ...
                                <div class="item">
                                    <div class="row">
                                        ...
                                        <div class="col-md-4 col-xs-412 d-flex align-items-stretch">
                                            <div class="card d-flex flex-column">
                                                <h2 class="gray-600 plugin-p"><strong>Plugins to customize automations
                                                        for invoices</strong></h2>
                                                <img class=" card-img-top p-2 mt-4"
                                                    src="{!! asset('/images/product/online-invoicing/features/automate-invoicing-with-plugins.svg') !!}"
                                                    alt="Create invoices or estimates" width="100%" height="200px"
                                                    loading="lazy" class="lazyload" />
                                ...
                                <div class="item">
                                    <div class="row">
                                        <div class="col-md-4 col-xs-12 d-flex align-items-stretch">
                                            <div class="card d-flex flex-column">
                                                <h2 class="gray-600 plugin-p"><strong>Convert estimates to
                                                        invoices</strong></h2>
                                                <img class=" card-img-top p-2 mt-4"
                                                    src="{!! asset('/images/product/online-invoicing/features/convert-estimates-to-invoicing.svg') !!}"
                                                    alt="Create invoices or estimates" width="100%" height="200px"
                            ...
                            <div class="mt-2">
                                ...
                                <a class="left carousel-control" style="background: transparent;"
                                    href="#theCarousel1" data-slide="prev"><button id="nexttab" class="btn btn-primary" ><</button></a>
                                <a class="right carousel-control" style="background: transparent;" href="#theCarousel1"
                                    data-slide="next"><button class="ml-4 btn btn-primary" >></button></a>
        ...
        <div class="row row-eq-height text-center pb-5">
            <div class="col-md-3">
                <div class="bg-white p-4 h-100">
                    ...
                    <p>Accurate GST calculations on every invoice without any manual intervention. Ensure GST compliance
                        and seamless monthly tax reconciliation.</p>
                </div>
            </div>
            <div class="col-md-3">
                <div class="bg-white p-4 h-100">
                    ...
                    <p>Cloud-based invoicing software, compatible with different operating systems & & devices. Easy
                        access to create & manage invoices on-the-go.</p>
                </div>
            </div>
            <div class="col-md-3">
                <div class="bg-white p-4 h-100">
                    ...
                    <p>Prompt payments with multiple payment options like Credit card, Debit card, Net banking, UPI,
                        eWallets, and more.</p>
                </div>
            </div>
            <div class="col-md-3">
                <div class="bg-white p-4 h-100">
                    <svg xmlns="http://www.w3.org/2000/svg" class="h-16 text-secondary pb-2" viewBox="0 0 512 512">
                    ...
                    <p>Automated payment reminders created & sent as per a customizable schedule that suits your needs.
                    </p>
                </div>
            </div>
                ...
                <div id="accordion" itemscope itemtype="http://schema.org/FAQPage">
                    <div class="card-header bg-white p-1" itemscope itemprop="mainEntity"
                        ...
                        <div id="collapseOne" class="collapse show" aria-labelledby="headingOne"
                            ...
                            <div class="card-body" itemprop="text">
                                Yes, You can use all our features for free. We only charge the lowest online payment <a
                                    href="{{ config('app.APP_URL') }}payment-gateway-charges"> transaction fee</a> for
                    ...
                    <div class="card-header bg-white p-1" itemscope itemprop="mainEntity"
                        ...
                        <div itemprop="name" class="btn btn-link color-black collapsed" data-toggle="collapse"
                            ...
                            <h4>Is there a limit to the number of customers I can add to Swipez’s invoicing software?
                            </h4>
                        </div>
                    ...
                    <div class="card-header bg-white p-1" itemscope itemprop="mainEntity"
                        ...
                        <div id="collapseThree" class="collapse" aria-labelledby="headingThree" data-parent="#accordion"
                            itemscope itemprop="acceptedAnswer" itemtype="http://schema.org/Answer">
                            <div class="card-body" itemprop="text">
                                We at Swipez value our customer’s privacy above all else. Merchants, e-commerce sellers,
                                and businesses rely on us for their invoicing & payment collections. And, we take that
                                responsibility and our duty of care towards them very seriously. The security of our
                                software, systems, and customer data are our number one priority.
                                <br /><br />
                                Every piece of information that is transmitted between your browser and Swipez is
                                protected with 256-bit SSL encryption. This ensures that your data is secure in transit.
                                All data you have entered into Swipez sits securely behind web firewalls. This system is
                                used by some of the biggest companies in the world and is widely acknowledged as safe
                                and secure.
                    ...
                    <div class="card-header bg-white p-1" itemscope itemprop="mainEntity"
                        ...
                        <div id="collapseFive" class="collapse" aria-labelledby="headingFive" data-parent="#accordion"
                            itemscope itemprop="acceptedAnswer" itemtype="http://schema.org/Answer">
                            <div class="card-body" itemprop="text">
                                We have a dedicated team of experts who will be happy to assist you. You can reach out
                                to us via email, chat, and our call center.
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="card-header bg-white p-1" itemscope itemprop="mainEntity"
                        ...
                        <div id="collapseSix" class="collapse" aria-labelledby="headingSix" data-parent="#accordion"
                            ...
                            <div class="card-body" itemprop="text">
                                ...
                                invoicing software. Our seamless <a href="{{ route('home.integrations') }}" target="_blank">integrations</a> ensure that you can start using the Swipez invoicing software effortlessly.
                    ...
                    <div class="card-header bg-white p-1" itemscope itemprop="mainEntity"
                        ...
                        <div id="collapseSeven" class="collapse" aria-labelledby="headingSeven" data-parent="#accordion"
                            itemscope itemprop="acceptedAnswer" itemtype="http://schema.org/Answer">
                            <div class="card-body" itemprop="text">
                                An invoice number is used to uniquely identify an estimate/invoice to ease billing your
                                customers. An invoice number can be numeric or alphanumeric value as per your
                                requirements. You can add an invoice number manually each time you create an invoice.
                                Or, create an invoice sequence and the invoices created with that sequence will have
                                invoice number auto generated for them.
                            </div>
                        </div>
                    </div>
                    {{-- //rem --}}
                    <div class="card-header bg-white p-1" itemscope itemprop="mainEntity"
                        ...
                        <div id="collapseEight" class="collapse" aria-labelledby="headingEight" data-parent="#accordion"
                            itemscope itemprop="acceptedAnswer" itemtype="http://schema.org/Answer">
                            <div class="card-body" itemprop="text">
                                Certainly. You can enable the deductibles plugin for your estimates. When your customer
                                makes a payment, the TDS amount will be automatically deducted from the estimate amount.
                                Moreover, once paid the estimate will automatically convert into an invoice.
                    ...
                    <div class="card-header bg-white p-1" itemscope itemprop="mainEntity"
                        ...
                        <div id="collapseNine" class="collapse" aria-labelledby="headingNine" data-parent="#accordion"
                            itemscope itemprop="acceptedAnswer" itemtype="http://schema.org/Answer">
                            <div class="card-body" itemprop="text">
                                You can enable the supplier plugin to ensure that your suppliers will be automatically
                                and immediately notified of any changes in an invoice via email and/or SMS.
                    ...
                    <div class="card-header bg-white p-1" itemscope itemprop="mainEntity"
                        ...
                        <div id="collapseTen" class="collapse" aria-labelledby="headingTen" data-parent="#accordion"
                            itemscope itemprop="acceptedAnswer" itemtype="http://schema.org/Answer">
                            <div class="card-body" itemprop="text">
                                Yes, you can add a discount coupon with a fixed amount. You can also create and add
                                discount coupons with percentage (%) discounts to your invoices, as per your
                                requirements.
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="card-header bg-white p-1" itemscope itemprop="mainEntity"
                        ...
                        <div id="collapseEleven" class="collapse" aria-labelledby="headingEleven"
                            ...
                            itemtype="http://schema.org/Answer">
                            <div class="card-body" itemprop="text">
                                Once you have enabled the CC plugin, you can add multiple email addresses as per your
                                discretion. Email notifications will be created and sent to each of the emails
                                automatically.
                    ...
                    <div class="card-header bg-white p-1" itemscope itemprop="mainEntity"
                        ...
                        <div id="collapseTwelve" class="collapse" aria-labelledby="headingTwelve"
                            ...
                            itemtype="http://schema.org/Answer">
                            <div class="card-body" itemprop="text">
                                The round off plugin when enabled removes decimal points to the <b>nearest</b> value.
                                For example, if the invoice total is ₹ 99.4 it will round off to ₹ 99. If the invoice
                                total is ₹ 99.6 it will round off to ₹ 100.
                    ...
                    <div class="card-header bg-white p-1" itemscope itemprop="mainEntity"
                        ...
                        <div id="collapseThirteen" class="collapse" aria-labelledby="headingThirteen"
                            ...
                            itemtype="http://schema.org/Answer">
                            <div class="card-body" itemprop="text">
                                Certainly. You can generate invoices for your franchises, feature their name, contact
                                information & more on the invoice. You can also automatically split payments with your
                                franchise once the invoice has been paid.
                            </div>
                        </div>
                    </div>
                    <div class="card-header bg-white p-1" itemscope itemprop="mainEntity"
                        ...
                        <div id="collapseFourteen" class="collapse" aria-labelledby="headingFourteen"
                            ...
                            itemtype="http://schema.org/Answer">
                            <div class="card-body" itemprop="text">
                                Yes, you can automatically split invoice payments with one or more vendors. You can
                                split the invoice amount among several vendors or pay the entire amount to one vendor,
                                as per your requirements.
                            </div>
                        </div>
                    </div>
                    <div class="card-header bg-white p-1" itemscope itemprop="mainEntity"
                        itemtype="http://schema.org/Question" id="headingFifteen">

                        <div itemprop="name" class="btn btn-link color-black collapsed" data-toggle="collapse"
                            data-target="#collapseFifteen" aria-expanded="false" aria-controls="collapseFifteen">
                            <h4>What are pre-paid invoices? What if the customer has paid only a portion of the invoice
                                total in advance?
                            </h4>

                        </div>
                        <div id="collapseFifteen" class="collapse" aria-labelledby="headingFifteenn"
                            data-parent="#accordion" itemscope itemprop="acceptedAnswer"
                            itemtype="http://schema.org/Answer">
                            <div class="card-body" itemprop="text">
                                Pre-paid invoices are created when the customer has made an advance payment for services
                                or products billed. With the pre-paid invoice plugin, you can generate a zero or
                                adjusted value invoice for your customer based on the amount received and the invoice
                                total.
                                <br /><br /> For example, if the Advance Received is ₹ 10,000 and the total cost of the
                                particulars with applicable taxes is also ₹ 10,000, you are creating a zero value
                                invoice for your customers. If the Advance Received is ₹ 10,000 and the total cost of
                                the particulars with applicable taxes is also ₹ 12,000, you are creating an invoice for
                                ₹ 2,000 that your customers need to pay.
                                <br /> <br /> In the case of the former scenario, your invoice will not include payment
                                options as the invoice total has been paid in full. In the second scenario, the pre-paid
                                invoice will include payment options for the outstanding ₹ 2,000 due.
                            </div>
                        </div>
                    </div>
                    <div class="card-header bg-white p-1" itemscope itemprop="mainEntity"
                        itemtype="http://schema.org/Question" id="headingSixteen">
                        ...
                        <div id="collapseSixteen" class="collapse" aria-labelledby="headingSixteen"
                            ...
                            itemtype="http://schema.org/Answer">
                            <div class="card-body" itemprop="text">
                                Covering notes provide a chance for you to thank your customer while also providing
                                context for your invoice. The invoices are also linked within the covering note,
                                allowing your consumers to read the invoice quickly and pay promptly.
                            </div>
                        </div>
                    </div>
                    <div class="card-header bg-white p-1" itemscope itemprop="mainEntity"
                        itemtype="http://schema.org/Question" id="headingSeventeen">
                        ...
                        <div id="collapseSeventeen" class="collapse" aria-labelledby="headingSeventeen"
                            ...
                            itemtype="http://schema.org/Answer">
                            <div class="card-body" itemprop="text">
                                Customer notifications are emails and SMSs sent to your customers when invoices are
                                created to inform them of the same. You can also send payment reminders for outstanding
                                dues with online payment options to ensure prompt payments.
                                You can personalize the notifications that will be presented to your customers to suit
                                your brand image, convey the message you want it to, and more as per your requirements.
                                You can also personalize the frequency at which notifications are generated & sent to
                                your customers to suit your needs.

                            </div>
                        </div>
                    </div>
                    <div class="card-header bg-white p-1" itemscope itemprop="mainEntity"
                        itemtype="http://schema.org/Question" id="headingEighteen">
                        ...
                        <div id="collapseEighteen" class="collapse" aria-labelledby="headingEighteen"
                            ...
                            itemtype="http://schema.org/Answer">
                            <div class="card-body" itemprop="text">
                                Good news you don’t have to. We’ll take care of it for you. Once you have enabled the
                                partial payment plugin and assigned the minimum amount you'd like your customer to pay
                                for your invoice, it remains open, allowing your customer to make repeated payments
                                until paid in full.
                                <br />Your customer's partial payments will be automatically detected and reported
                                against the invoice. Both you and your customer will be able to see how many
                                transactions have been made against an invoice, how much has been paid, and how much is
                                still owed, in real time.
                    ...
                    {{-- remain --}}
                    <div class="card-header bg-white p-1" itemscope itemprop="mainEntity"
                        itemtype="http://schema.org/Question" id="headingNineteen">
                        ...
                        <div id="collapseNineteen" class="collapse" aria-labelledby="headingNineteen"
                            ...
                            itemtype="http://schema.org/Answer">
                            <div class="card-body" itemprop="text">
                                Certainly. You and your customers can choose the frequency at which dues will be auto
                                collected for recurring invoices. For more details on the same, <a
                                    href="/getintouch/billing-software-pricing">get in touch</a>, and we will be happy
                    ...
                    <div class="card-header bg-white p-1" itemscope itemprop="mainEntity"
                        itemtype="http://schema.org/Question" id="headingTwentyoneadd">

                        <div itemprop="name" class="btn btn-link color-black collapsed" data-toggle="collapse"
                            data-target="#collapseTwentyoneadd" aria-expanded="false"
                            aria-controls="collapseTwentyoneadd">
                            <h4>Can I create subscriptions in bulk?</h4>
                        </div>
                        <div id="collapseTwentyoneadd" class="collapse" aria-labelledby="headingTwentyoneadd"
                            data-parent="#accordion" itemscope itemprop="acceptedAnswer"
                            itemtype="http://schema.org/Answer">
                            <div class="card-body" itemprop="text">
                                Certainly. A simple excel upload is all it takes. You can specify details for each
                                subscription like the mode of the subscription, frequency, due date, end date & more as
                                per your requirements. Upload the filled excel sheet and recurring invoices will be
                                automatically created and sent to the different customers for the subscriptions as per
                                your specifications.
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="card-header bg-white p-1" itemscope itemprop="mainEntity"
                        ...
                        <div id="collapseTwenty" class="collapse" aria-labelledby="headingTwenty"
                            ...
                            itemtype="http://schema.org/Answer">
                            <div class="card-body" itemprop="text">
                                You can attach any file, in any format you want to your invoices. You can upload pdfs,
                                sheets, documents, images & more. They just have to be below 3 MB in size.
                            </div>
                        </div>
                    </div>
                    <div class="card-header bg-white p-1" itemscope itemprop="mainEntity"
                        itemtype="http://schema.org/Question" id="headingTwentyone">

                        <div itemprop="name" class="btn btn-link color-black collapsed" data-toggle="collapse"
                            data-target="#collapseTwentyone" aria-expanded="false" aria-controls="collapseTwentyone">
                            <h4>How to add a digital signature to invoices? Why are digital signatures essential for
                                online invoicing?
                            </h4>
                        ...
                        <div id="collapseTwentyone" class="collapse" aria-labelledby="headingTwentyone"
                            ...
                            itemtype="http://schema.org/Answer">
                            <div class="card-body" itemprop="text">
                                You choose to upload a PDF or Image file of your signature to start adding them to your
                                invoices. Or, choose one of the customizable, Swipez generated variations of your
                                signature to start adding them to your invoices. You can personalize the font, size,
                                alignment & more of the signature to suit your needs.
                                <br /><br />
                                All invoices uploaded on to the GST portal for GST filings must be digitally signed, in
                                accordance to GST regulations. Digital signatures are essential for online invoicing,
                                not just as a good business practice, but as an official government mandate.

                            </div>
                        </div>
                    </div>
                    <div class="card-header bg-white p-1" itemscope itemprop="mainEntity"
                        itemtype="http://schema.org/Question" id="headingTwentytwo">

                        <div itemprop="name" class="btn btn-link color-black collapsed" data-toggle="collapse"
                            data-target="#collapseTwentytwo" aria-expanded="false" aria-controls="collapseTwentytwo">
                            <h4>Will the previous dues be calculated automatically or do I need to add it manually?
                            </h4>
                        ...
                        <div id="collapseTwentytwo" class="collapse" aria-labelledby="headingTwentytwo"
                            ...
                            itemtype="http://schema.org/Answer">
                            <div class="card-body" itemprop="text">
                                If the previous due has been enabled, any outstanding dues of the customer for whom the
                                invoice is being created will be automatically added to the invoice total. You can rest
                                assured that manual intervention is not required to ensure accurate calculation of dues.
                            </div>
                        </div>
                    </div>
                    <div class="card-header bg-white p-1" itemscope itemprop="mainEntity"
                        itemtype="http://schema.org/Question" id="headingTwentythree">
                        ...
                        <div id="collapseTwentythree" class="collapse" aria-labelledby="headingTwentythree"
                            ...
                            itemtype="http://schema.org/Answer">
                            <div class="card-body" itemprop="text">
                                Yes, you simply have to turn the toggle for online payments off and we will take care of
                                the rest. The invoices/estimates your customers receive will not include online payment
                                options.
                            </div>
                        </div>
                    </div>
                    <div class="card-header bg-white p-1" itemscope itemprop="mainEntity"
                        itemtype="http://schema.org/Question" id="headingTwentyfour">
                        ...
                        <div id="collapseTwentyfour" class="collapse" aria-labelledby="headingTwentyfour"
                            ...
                            itemtype="http://schema.org/Answer">
                            <div class="card-body" itemprop="text">
                                Yes, you can personalize your customer's payment receipts to suit your needs. You can
                                add or remove information fields from the payment receipts to capture the information
                                that you want to reflect in the receipts.
                            </div>
                        </div>
                    </div>
                    <div class="card-header bg-white p-1" itemscope itemprop="mainEntity"
                        itemtype="http://schema.org/Question" id="headingTwentyfive">

                        <div itemprop="name" class="btn btn-link color-black collapsed" data-toggle="collapse"
                            data-target="#collapseTwentyfive" aria-expanded="false" aria-controls="collapseTwentyfive">
                            <h4>Does Swipez offer GST e-invoicing? Can I upload GST e-invoices directly from Swipez?
                            </h4>
                        ...
                        <div id="collapseTwentyfive" class="collapse" aria-labelledby="headingTwentyfive"
                            ...
                            itemtype="http://schema.org/Answer">
                            <div class="card-body" itemprop="text">
                                Yes, Swipez provides a <a href="{{ config('app.APP_URL') }}e-invoicing">GST
                                    e-invoicing</a> solution that allows you to upload your electronic invoices straight
                                to the Invoice Registration Portal (IRP). A unique Invoice Reference Number (IRN), a
                                digital signature, and a QR code will be used to validate the invoices.
                                You can also bulk upload invoices via excel sheets to initiate GST e-invoicing. If you
                                want to integrate the API you have generated directly from the IRP with the Swipez
                                dashboard, you can do that too.

                            </div>
                        </div>
                    </div>
                    <div class="card-header bg-white p-1" itemscope itemprop="mainEntity"
                        itemtype="http://schema.org/Question" id="headingTwentysix">
                        ...
                        <div id="collapseTwentysix" class="collapse" aria-labelledby="headingTwentysix"
                            ...
                            itemtype="http://schema.org/Answer">
                            <div class="card-body" itemprop="text">
                                Good news you don’t have to. We’ll take care of it for you. Once you generate an
                                invoice, your inventory will be automatically updated in real-time.
                            </div>
                        </div>
                    </div>

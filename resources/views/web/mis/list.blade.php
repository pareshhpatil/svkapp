    ...
    function datatable() {
        ...
        if (dt_basic_table.length) {
            dt_basic = dt_basic_table.DataTable({
                ajax: '/ajax/mis/generate/' + project_id + '/' + date ,
                columns: [{
                        data: 'id'
                    },
                    {
                ...
                columnDefs: [{
                    ...
                    render: function(data, type, full, meta) {
                        return (
                            '<div class="d-inline-block"><a href="javascript:;" class="btn-icon dropdown-toggle hide-arrow" data-bs-toggle="dropdown"><i class="text-primary ti ti-dots-vertical"></i></a><ul class="dropdown-menu dropdown-menu-end m-0"><li><a href="/mis/generate/'+full.id+'" class="dropdown-item">Generate MIS</a></li></ul></div>'                            
                        );
                    }
                }],
                order: [

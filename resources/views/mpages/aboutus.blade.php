  ...
  <section class="text-gray-600 body-font overflow-hidden gray-bg-1">
    <div class="container px-4 lg:px-40 py-24 mx-auto">
      <div class="-my-8 divide-y-2 divide-gray-100">
        <div class="py-8 flex flex-wrap md:flex-nowrap bg-white rounded-2xl px-4">
          <div class="md:flex-grow">
            <h2 class="text-2xl font-medium text-gray-500 title-font mb-2">About Us</h2>
            <!-- <p class="leading-relaxed">Glossier echo park pug, church-key sartorial biodiesel vexillologist pop-up snackwave ramps cornhole. Marfa 3 wolf moon party messenger bag selfies, poke vaporware kombucha lumbersexual pork belly polaroid hoodie portland craft beer.</p> -->
            <p class="leading-relaxed">{!!$merchant_detail->about_us!!}</p>
          </div>
        </div>
      </div>
    </div>

        ...
        <div class="col-md-12">
            <div class="portlet light bordered">
                <div class="portlet-body form">
                    ...
                    <form action="/merchant/hsn-sac-code/store" method="post" class="form-horizontal form-row-sepe">
                            ...
                            <div class="row">
                                <div class="col-md-12">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-md-5">
                                            <input type="text" required="true" maxlength="8" name="code" class="form-control" placeholder="HSN/SAC code">
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        ...
                                        <div class="col-md-5">
                                            <input type="number" required="true" min="0" step="1" name="gst" class="form-control" placeholder="GST percent">
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        ...
                                        <div class="col-md-8">
                                            <textarea required="true" name="description" class="form-control" placeholder="Description" rows="15"></textarea>
                                        </div>
                                    </div>
                                </div>
                            </div>

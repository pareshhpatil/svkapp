                            ...
                            <div class="row">
                                <div class="col-md-6">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-md-8">
                                            <select class="form-control select2me" onchange="projectSelected(this.value);document.getElementById('perror').style.display = 'none';" data-placeholder="Select project" required name="project_id" id="project_id">

            ...
            <div class="col-md-12">
                ...
                <div class="portlet">
                    ...
                    <div class="portlet-body">
                        <form action="/merchant/cost-types/update/{{$costType->id}}" onsubmit="loader();" method="post" class="form-horizontal">
                            {{ csrf_field() }}
                                        ...
                                        <div class="row">
                                            <div class="col-md-12">
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <div class="col-md-8">
                                                        <input type="text" required minlength="1" maxlength="2" name="abbrevation" class="form-control" value="{{$costType->abbrevation}}" placeholder="Cost type Abbrevation">
                                                    </div>
                                                </div>

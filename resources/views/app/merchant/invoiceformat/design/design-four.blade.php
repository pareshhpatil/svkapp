       ...
       @endphp --}}
                    ...
                    <div class="col-span-2">
                        ...
                        <div class="grid grid-cols-1 lg:grid-cols-2 md:grid-cols-2 gap-2 justify-left">
                            <div class="ml-0 lg:ml-6 md:ml-6  ">
...
{{$gstontop=1}}
                ...
                <div class="grid grid-cols-1 lg:grid-cols-3 md:grid-cols-3 gap-2 mt-4">
                    <div class="border-t-2 border-dotted border-gray-400 pt-4">
                        ...
                        <h1 class="text-sm font-bold text-black ">Bill To</h1>
                    ...
                    <div class="ml-0 lg:ml-4 md:ml-4 border-t-2 border-dotted border-gray-400 pt-4">
                        ...
                        <p class="text-left py-0.2"><span class=" text-black text-sm font-semibold">Payment Method </span> <span class="ml-2 text-sm text-black">{{$info['payment_mode']}}</p>
                        </p>
                        @endisset
                        @isset($info['transaction_id'])
                        <p class="text-left py-0.2"><span class=" text-black text-sm font-semibold">Transaction Number</span> <span class="ml-2 text-sm text-black">{{$info['transaction_id']}}</p>
                        </p>
                        @endisset
                    </div>
                ...
                <div class='overflow-x-auto w-full mt-4'>
                    ...
                    $total=0;
                    $taxtotal=0;
                    $number_keys=array('annual_recurring_charges','previous_amount','rate','total_amount')
                    @endphp
                        ...
                        <tbody class="divide-y divide-dashed divide-gray-200 ">
                            ...
                            <tr>
                                ...
                                <td class="px-2 py-2 @if($k!='item') text-center @endif">
                                    ...
                                    @else
                                    <p class="text-sm"> 
                                    @if(in_array($k,$number_keys))
                                    <x-amount-format :amount="$item[$k]" />
                                    @else 
                                    {{$item[$k]}}
                                    @endif    
                                     </p>
                    ...
                    <div>
                        <div class="flex justify-between mb-0 px-2 py-1 mt-2">
                            ...
                            <div class="text-right">
                                <div class="text-gray-700 text-sm">{{$info['currency_icon']}}<x-amount-format :amount="$info['basic_amount']" /></div>
                      ...
                      "> (Inclusive of tax)</div>
                        ...
                        <div class="border-t border-[{{$colors}}]">
                            <div class="flex justify-between px-2 py-2">
                                ...
                                <div class="text-right">
                                    <div class="text-sm text-gray-800 ">{{$info['currency_icon']}}<x-amount-format :amount="$total" /></div>
                                </div>
                            </div>
                        ...
                        <div class="py-1 border-t border-[{{$colors}}] ">
                            <div class="flex justify-between px-2 py-1">
                                ...
                                <div class="text-right ">
                                    <div class="text-sm text-gray-800 ">{{$info['currency_icon']}}<x-amount-format :amount="$info['advance']" /></div>
                                </div>
                            </div>
                        ...
                        <div class="py-1 border-t border-[{{$colors}}] ">
                            <div class="flex justify-between px-2 py-1">
                                ...
                                <div class="text-right ">
                                    <div class="text-sm text-gray-800 ">{{$info['currency_icon']}}<x-amount-format :amount="$info['paid_amount']" /></div>
                                </div>
                            </div>
                        ...
                        <div class="py-1 border-t border-[{{$colors}}] ">
                            <div class="flex justify-between px-2 py-1">
                                ...
                                <div class="text-right">
                                    <div class="text-sm text-gray-800 ">{{$info['currency_icon']}}<x-amount-format :amount="$info['absolute_cost']" /></div>
                                </div>
                            </div>
                    ...
                    <div class=" border-t border-[{{$colors}}]  border-b-2">
                        <div class="flex justify-between">
                            ...
                            <div class="text-right bg-[{{$colors}}]">
                                <div class="text-sm text-white px-2 py-2 ">{{$info['currency_icon']}}<x-amount-format :amount="$info['absolute_cost']" /></div>
                            </div>
                        </div>
            ...
            <div class="row">
                <div class="col-md-12">
                    <div class="pull-{{$info['signature']['align']}}" style="margin-{{$info['signature']['align']}}: 20px;">
                        ...
                        <label style="font-family: '{{$info['signature']['font_name']}}',cursive;font-size: {{$info['signature']['font_size']}}px;">{{$info['signature']['name']}}</label>
                        @else

...
@endphp
      ...
      @endif
        ...
        <div class="border-t-2  border-[{{$colors}}]  mt-2 mb-2" ></div>
        <div class="grid grid-cols-1 lg:grid-cols-2 md:grid-cols-2  gap-4">
            ...
            <div >
                ...
                <tr>
                 ...
                 <tr>
                    ...
                    <p class="text-sm  text-left "><x-localize :date="$item['value']" type="date" /> </p>
                    @else
            ...
            @if (!empty($table_heders))
                <table class= ' mx-auto  w-full  bg-white  overflow-hidden'>
                    <thead >
 ...
 <div class="grid grid-cols-1  md:grid-cols-2 lg:grid-cols-2 gap-4 p-0 lg:p-2 md:p-2">

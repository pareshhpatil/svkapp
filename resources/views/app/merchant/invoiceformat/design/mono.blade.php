...
<div class="font-rubik  w-full   bg-white  shadow-2xl p-6 " style="max-width: 910px">
  ...
  $previous_due_col="Previous due";
   @endphp
    ...
    <div class="grid grid-cols-1 lg:grid-cols-2 md:grid-cols-2 gap-4 justify-center p-0 lg:p-4 md:p-4 mb-4 lg:mb-0 md:mb-0 mt-4 lg:mt-0 md:mt-0">
        <div> 
    ...
    <hr>
    <div class="grid grid-cols-1 lg:grid-cols-3 md:grid-cols-3 gap-4 justify-center p-0 lg:p-4 md:p-4 mt-4 lg:mt-0 md:mt-0">
       @if(isset($info['payment_mode']) || isset($info['transaction_id']))
        ...
        <div> 
            ...
            @foreach ($metadata['invoice'] as $key=>$item)
                @if( $item['value']!="" && $item['function_id']!=4 && $item['datatype']=='date')

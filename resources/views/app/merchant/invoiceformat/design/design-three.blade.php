...
@endif
    <div class="grid lg:grid-cols-4 md:grid-cols-4 sm:grid-cols-1 justify-left ">
        <div class="mt-0  p-2 mr-12 col-span-2">
            @if(!empty($info['image_path']))
            <section class="flex flex-wrap justify-left ">
                <img class="max-h-24 " src="{{$info['image_path']}}" >  
                 </section>  
                 @endif
    </div>
    @php
...
@endphp
  ...
  @endphp
    ...
    <div class="grid grid-cols-1 lg:grid-cols-2 md:grid-cols-2 gap-4 justify-center p-0 lg:p-4 md:p-4 mt-4  lg:mt-0 md:mt-0">
      ...
      @endif
        ...
        <div class="border-t lg:border-t-0 md:border-t-0 lg:border-l md:border-l  border-gray-400 px-0 lg:px-4 md:px-4"> 
            <h1 class=" text-sm  font-regular text-gray-600 uppercase">Client</h1>
    ...
    <div class=" border-t-2 lg:border-t md:border-t border-dotted border-gray-700 mt-1"></div>

    <div class="grid grid-cols-1 lg:grid-cols-2 md:grid-cols-2 gap-4 justify-center p-0 lg:p-4 md:p-4 mt-0  lg:mt-0 md:mt-0">
        ...
        <div> 
           ...
           @isset($info['transaction_id'])
            <p class="text-sm uppercase mt-1" >Transaction Number:<span class="ml-4 font-semibold">{{$info['transaction_id']}}</span></p>
        @endisset
        </div>  
        @endisset
        <div> 
          
            <p class=" text-1xl uppercase"> {{$info['footer_note']}}</p>
            </div>
    </div>

    @if ($info['footer_note']!='' || isset($info['payment_mode']))
    <div class=" border-t-2 lg:border-t md:border-t border-dotted border-gray-700 mt-0"></div>

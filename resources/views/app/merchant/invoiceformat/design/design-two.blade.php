    ...
    <div class="grid grid-cols-1 lg:grid-cols-3 md:grid-cols-3  gap-2 mt-4">
        <div class="block lg:hidden md:hidden mt-2">
            ...
            <section class="flex flex-wrap  ">
                <img class=" h-10 " src="{{$info['image_path']}}" style="max-height: 80px;">     
            </section>  
            @endif
    </div>
    {{-- @php
...
@endphp
    ...
    <div class="grid grid-cols-1 lg:grid-cols-3 md:grid-cols-3 gap-4 mt-4">
        <div>
           ...
           @endif
            ...
            <p class="text-1xl uppercase mb-2 font-semibold  mt-1">{{$inv}}</p>
        ...
        <div class="text-center">
           ...
           @endif
            ...
            <p class="text-1xl uppercase mb-2 font-semibold  mt-1"><x-localize :date="$info['due_date']" type="date" /></p>
        ...
        <div>
            ...
            <p class="text-1xl uppercase mb-2 font-semibold  mt-1 text-left lg:text-right md:text-right">{{$info['currency_icon']}}{{$info['absolute_cost']}}</p>
            <div class="border-b border-gray"></div>
        </div>
    ...
    <div class="grid grid-cols-1 lg:grid-cols-2 md:grid-cols-3  gap-4 mt-2">
       ...
       <p class="text-sm  text-gray-500 mt-1">{{$item['column_name']}}: {{$info['currency_icon']}}{{number_format($item['value'],2)}}</p>
      
       @elseif($item['datatype']=='date')
       <p class="text-sm  text-gray-500 mt-1">{{$item['column_name']}}: <x-localize :date="$item['value']" type="date" /></p>
     @else
       ...
       @endforeach
        ...
        @if (!empty($table_heders))
            <table class=' mx-auto  w-full  bg-white divide-y-2 divide-[{{$colors}}] overflow-hidden'>
                <thead >

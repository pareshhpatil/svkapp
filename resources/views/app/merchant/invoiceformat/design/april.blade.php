...
<div class=" w-full flex flex-col items-center justify-center  " >
    ...
    <div class="p-4 mt-4  lg:p-8 md:p-8">
        <div class="grid grid-cols-1  md:grid-cols-3 lg:grid-cols-3 gap-1  justify-left p-0 lg:p-4 md:p-4 mt-0">
          ...
          @endphp
                <h1 class="text-3xl lg:mt-0 md:mt-0 font-semibold tracking-widest text-[{{$colors}}] ">INVOICE</h1>
        ...
        <div class="grid grid-cols-1  md:grid-cols-2 lg:grid-cols-2 gap-4 p-0">
            ...
            <div>
                ...
                <div class="flex justify-between mb-0 px-2 py-1 border-t border-[{{$colors}}] mt-1">
                    ...
                    <div class="text-right w-20">
                        <div class="text-sm text-gray-700" x-html="totalGST">{{$info['currency_icon']}}{{$item['tax_amount']}}</div>
                    </div>
                </div>
                @php
        ...
        <div class="mt-1 grid grid-cols-1  md:grid-cols-2 lg:grid-cols-2 gap-4 p-1 border-dashed border-2 border-[{{$colors}}]">
            ...
            <div class="flex justify-left ">
                ...
                <div class="text-center ml-8">
                    <div class="text-xl text-[{{$colors}}] font-medium py-1" >{{$info['currency_icon']}}{{number_format($info['absolute_cost'],2)}}</div>
                </div>
            </div>
        </div>
...
@if (isset($metadata['plugin']['has_digital_certificate_file']) && $metadata['plugin']['has_digital_certificate_file']==1)
   ...
   @else
    ...
    <div class="bg-gray-100">
        <div class="p-4 lg:p-12 md:p-10">
            <div class="grid grid-cols-1 lg:grid-cols-3 md:grid-cols-3 gap-4">

                <div class="col-span-2">
                    <div class="flex items-center text-black justify-self  font-medium mt-2">
            ...
            <hr>
            {{-- <div>
                <p class="mt-4 text-gray-600 text-sm text-center font-regular ">Super co | Email:rohitsharma@gmail.com | Website:www.rohitsharma.com | Facebook:ackm | Twitter:ackm</p>
                <p class="mt-4 text-gray-600 text-sm text-center font-regular mb-2">Created by Swipez</p>
            </div> --}}
        </div>

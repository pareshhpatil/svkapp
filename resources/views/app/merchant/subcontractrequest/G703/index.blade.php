...
<div class="page-content" style="text-align: -webkit-center !important;">
    ...
    <div class="w-full flex flex-col  justify-center" style="background-color: #F7F8F8;min-height: 344px;    padding: 20px 10px 20px 10px;">
        ...
        <div class="page-bar">
            ...
            {{ Breadcrumbs::render('home.requestpayment.view','a') }}
        ...
        <div class=" w-full flex flex-col items-center justify-center">
            @if($user_type=='merchant')
                <div class="w-full" style="max-width: 1400px;">
                    @include('app.merchant.subcontractrequest.view.invoice-alert')
                </div>
            @endif

            @include('app.merchant.subcontractrequest.view.header')
            @include('app.merchant.subcontractrequest.G703.content')
            
            @php
            $footers='app.merchant.subcontractrequest.view.footer-v2';
            if($user_type=='merchant')
            {
            $footers='app.merchant.subcontractrequest.view.footer-v2';}
            else{

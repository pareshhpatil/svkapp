                            ...
                            <table class="table table-bordered table-hover" id="particular_table">
                                ...
                                <tbody id="new_particular">
                                    ...
                                    <tr>
                                        ...
                                        <td class="col-id-no">
                                            <input numbercom="yes" onkeyup="updateTextView($(this));" type="text" data-cy="particular_{{$v}}{{$key+1}}" class="form-control pc-input" value="" id="{{$v}}{{$key+1}}" name="{{$v}}[]" onblur="calculateChangeOrder()" />
                                        </td>
                                ...
                                <tfoot>
                                    <tr class="warning">
                                        ...
                                        <th>Grand total</th>
                                        <th class="td-c">
                                            <input type="text" id="particulartotal1" data-cy="particular-total1" name="totalcost" value="0" class="form-control" readonly>
                                        </th>
                                        <th></th>
                                        <th></th>
                                    </tr>

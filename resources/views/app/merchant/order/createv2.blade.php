                            ...
                            <div class="form-group mb-0">
                                <div class="col-md-12">
                                    <div class="col-md-3 pl-1 pr-0">
                                        <select data-placeholder="Select @if($type=='subcontract')sub @endif contract" required class="form-control select2me" name="contract_id">
                                            <option value=""></option>
                ...
                <div class="portlet-body form">
                    ...
                    <form action="/merchant/order/save" id="frm_expense" onsubmit="return changerOrderAmountCheck();loader();" method="post" enctype="multipart/form-data" class="form-horizontal form-row-sepe">
                        ...
                        <div class="row">
                            ...
                            <div class="row">
                                <div class="col-md-7">
                                <input type="text" id="search" class="form-control pull-right" placeholder="Search Item No and Description of work">
                                </div>
                                <div class="col-md-5">
                                ...
                                <a data-cy="add_particulars_btn" href="javascript:;" onclick="AddInvoiceParticularRowOrderV2();" class="btn green pull-right mb-1"> Add new row </a>
                                    ...
                                    @endif
                                <button class="btn green pull-left mb-1" type='button' onclick="return filterRows();">Search</button>
                            ...
                            <div class="row">
                                <div class="col-md-12">
                                    <div class="pull-right">
                                        ...
                                        <input type="submit" value="{{$button}}" class="btn blue"  />
                                    </div>
                                </div>
                            </div>
                        </div>

...
<div class="panel-wrap" id="updatepanelWrapIdBillCode">
    ...
    <div class="panel">
        <div class='cnt223'>
            <h3 class="modal-title">Update bill code
                            ...
                            <div class="row">
                                <div class="col-md-12">
                                    <div class="form-group">
                                        ...
                                        <div class="col-md-5">
                                            <input type="text" required="true" maxlength="45" name="bill_code" id="bill_code" class="form-control" placeholder="Enter bill code">
                                        </div>
                                    </div>
                                    <!-- <div class="form-group">
                                ...
                                <div class="col-md-5">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-md-5">
                                            <input type="text" required="true" maxlength="100" name="bill_description" id="bill_description" class="form-control" placeholder="Enter bill description">
                                        </div>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="row">
                                <div class="col-md-12">
                                    <div class="pull-right">
                                        ...
                                        <input type="submit" value="Update bill code" onclick="return updatebillcode();" class="btn blue" />
                                    </div>
                                </div>
                            </div>
                        </div>

                                ...
                                <td style="font-size:15px; line-height:30px;">
                                    <table width="100%" border="0" cellspacing="0" cellpadding="5">
                                        <tbody>
                                            <tr>
                                                <td width="280" style="">
                                                    <span style="font-size:20px; color:#6e605d;">{{$detail->name}}</span>
                                                    <span style="font-size:13px; display:block; margin-top:5px; margin-bottom:1px;line-height: 16px;"> {{$detail->address}} </span>
                                                    @if($detail->state !='')<span style="font-size:13px; display:block; margin-top:1px; margin-bottom:1px;line-height: 16px;">
                                                        <div class="input-group">State: {{$detail->state}}</div>
                                                    </span>@endif
                                                    @if($detail->mobile !='')<span style="font-size:13px; display:block; margin-top:1px; margin-bottom:1px;line-height: 16px;">
                                                        <div class="input-group"> Contact: {{$detail->mobile}}</div>
                                                    </span>
                                                    @endif
                                                    @if($detail->email_id !='')<span style="font-size:13px; display:block; margin-top:1px; margin-bottom:1px;line-height: 16px;">
                                                        <div class="input-group"> Email: {{$detail->email_id}}</div>
                                                    </span>
                                                    @endif
                                                    @if($detail->gst_number !='')<span style="font-size:13px; display:block; margin-top:1px; margin-bottom:1px;line-height: 16px;">
                                                        <div class="input-group"> GST Number: {{$detail->gst_number}}</div>
                                                    </span>
                                                    @endif
                                                </td>
                                                    ...
                                                    <table border="0" cellspacing="0" cellpadding="5" style="color:#5b4d4b;font-size: 13px;line-height: 14px;">
                                                        ...
                                                        <tbody>
                                                            ...
                                                            <tr>
                                                                ...
                                                                <td style="min-width: 120px;">
                                                                    <x-localize :date="$detail->due_date" type="datetime" />

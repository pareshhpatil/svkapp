                                    ...
                                    <td>
                                        <div class="btn-group dropup">
                                            ...
                                            <ul class="dropdown-menu pull-right" role="menu">
                                                <li>
                                                    <a href="/merchant/debitnote/view/{{$v->encrypted_id}}"><i class="fa fa-table"></i> View</a>
                                                </li>
                                                <li>
                                                    <a href="/merchant/debitnote/update/{{$v->encrypted_id}}"><i class="fa fa-edit"></i> Update</a>
                                                </li>
                                                <li>
                                                    <a href="#basic" onclick="document.getElementById('deleteanchor').href = '/merchant/expense/debitnote/delete/{{$v->encrypted_id}}'" data-toggle="modal"><i class="fa fa-times"></i> Delete</a>
                                                </li>
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
                ...
                <h4 class="modal-title">Delete debit note</h4>
            </div>
            <div class="modal-body">
                Are you sure you would not like to use this debit note in the future?
            </div>

    ...
    <div class="row">
        ...
        <div class="col-md-10">
            ...
            <div class="invoice" style="max-width: 900px;border: 1px solid lightgrey !important;text-align: left;">
                <div class="row invoice-logo  no-margin" style="margin-bottom: 0px;">
                    ...
                    <div class="col-md-8">
                        <p style="text-align: left;">
                            <a  style="font-size: 27px;">{{$detail->name}}</a> 
                            <br>
                ...
                <div class="row no-margin">
                    <div class="col-md-12">
                        <a class="btn green hidden-print margin-bottom-5 pull-right" style="margin-right: 20px;" href="/merchant/debitnote/update/{{$link}}">
                            Update
                        </a>
                        <a class="btn blue hidden-print margin-bottom-5 pull-right" style="margin-right: 20px;" href="/merchant/debitnote/download/{{$link}}">
                            Save as PDF
                        </a>
                    </div>
                </div>

        ...
        <script>
            ...
            function handler_create() {
                ...
                return {
                    ...
                    calculateRetainageAmount(field){
                            try {
                    ...
                    calculateRetainageStoreMaterialAmount(field){
                            try {
                            if(field.retainage_percent_stored_materials==null)
                            {
                                field.retainage_percent_stored_materials='';
                            }

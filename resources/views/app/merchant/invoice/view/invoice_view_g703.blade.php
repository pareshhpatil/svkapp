                            ...
                            <tr>
                                ...
                                <td>
                                    <p class="ml-2 text-xs font-bold">
                                        {{ $info['invoice_number'] ? $info['invoice_number'] : 'NA' }}
                                    </p>
                                </td>
                            </tr>
                            <tr>
                        ...
                        <tbody>
                            ...
                            <tr class="border-row">
                                ...
                                <td class="border-r border-l border-[#A0ACAC] px-2 py-2 text-left">
                                    ...
                                    @else
                                    <p class="text-sm">{{ $item['b'] }} @if (!empty($item['attachment']))
                                        <a href="/{{ $info['user_type'] }}/invoice/document/{{ $info['Url'] }}/{{str_replace(' ', '_', strlen($item['a']) > 7 ? substr($item['a'], 0, 7) : $item['a']) }}/{{ $item['attachment'] }}">
                                            <i class="fa fa-paperclip popovers" data-placement="right" data-container="body" data-trigger="hover" data-content="{{ $item['files'] }}" aria-hidden="true"></i></a>
                                        @endif
                                    </p>
                                    @endif

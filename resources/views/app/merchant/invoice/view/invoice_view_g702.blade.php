                    ...
                    <div>
                        ...
                        <div class="grid grid-cols-3 gap-2 mt-1">
                            <div class="col-span-2">
                                ...
                                @php
                                $cper=0;
                                if(($info['total_d']+$info['total_e']) <= 0){ $cper=0;} else{ $cper=number_format((($info['total_i']/($info['total_d']+$info['total_e']))*100),2);} $a5=0; $single_per=($info['total_d']+$info['total_e'])/100; $a5=$single_per*$cper; @endphp <p class="font-bold text-xs mt-1">a. <span class="font-light border-b border-gray-600">{{number_format($info['percent_rcw'],2)}}</span><span class="font-light"> % of Completed Work <span class="italic ">(Columns D + E on G703)</span></span> </p>
                        ...
                        <table class="mt-2 w-full border-collapse border border-gray-500 overflow-hidden">
                            ...
                            <tr>
                                ...
                                <td class="border-collapse border-r border-gray-500 py-1 px-1">
                                    <p class="text-xs text-right">{{$info['currency_icon']}}@if($info['last_month_co_amount_positive']>=0){{number_format($info['last_month_co_amount_positive'],2)}}@else{{0}} @endif </p>
                                </td>
                                <td class="py-1 px-1">
                                    <p class="text-xs text-right">{{$info['currency_icon']}}@if($info['last_month_co_amount_negative']<0)({{str_replace('-','',number_format($info['last_month_co_amount_negative'],2))}})@else{{0}} @endif </p>
                                </td>
                            </tr>
                            <tr>
                                <td class="border-collapse border border-gray-500 py-1 px-1">
                                ...
                                <td class="border-collapse border border-gray-500 py-1 px-1">
                                    <p class="text-xs text-right">{{$info['currency_icon']}}@if($info['this_month_co_amount_positive']>=0){{number_format($info['this_month_co_amount_positive'],2)}}@else{{0}} @endif </p>
                                </td>
                                <td class="border-collapse border border-gray-500 py-1 px-1">
                                    <p class="text-xs text-right">{{$info['currency_icon']}}@if($info['this_month_co_amount_negative']<0)({{str_replace('-','',number_format($info['this_month_co_amount_negative'],2))}})@else{{0}} @endif </p>
                                </td>
                            </tr>
                            <tr>
                                ...
                                @endphp
                                <td class="border-collapse border-r border-gray-500 py-1 px-1">
                                    <p class="text-xs text-right">{{$info['currency_icon']}}{{number_format($tt,2)}} </p>
                                </td>
                                <td class="py-1 px-1">
                                    <p class="text-xs text-right">{{$info['currency_icon']}}@if(number_format($tt1,2)<0)({{str_replace('-','',number_format($tt1,2))}}) @else{{number_format($tt1,2)}} @endif </p>
                                </td>
                            </tr>
                            <tr>
                                <td class="border-collapse border border-gray-500 py-1 px-1">

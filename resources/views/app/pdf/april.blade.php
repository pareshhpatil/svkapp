    ...
    <table style="width: 100%"  role="presentation">
                ...
                <tr>
                  <td style="border: 1px solid gray; background-color: #fff; ">
                        <div style="height: 20px; width: 100%; background-color: {{$info['design_color']}}"></div>
                    <div style="margin-top: 16px; padding: 16px">
                        <table  role="presentation">
                            <tr>                            <td style="min-width: 140px;vertical-align: top !important; padding-right: 15px">
                                 <h1 style="margin-top: 0; font-size: 30px; font-weight: 600; color: {{$info['design_color']}}">INVOICE</h1>
                             ...
                             @php $previous_due_col=$item['column_name']; @endphp
                                ...
                                <span style="font-size: 14px; color: #000"> {{$info['currency_icon']}}{{number_format($item['value'],2)}}</span> <br>
                                @elseif($item['datatype']=='date')
                 
                                <span style="font-size: 14px; color: #000"> {{date("d-M-Y", strtotime($item['value']))}}</span> <br> 
                                @else
                ...
                @endforeach 
                            ...
                            <td style="vertical-align: top !important; padding-left: 15px">
...
<div style="flex: 1 1 0%; font-size: 14px; color: rgb(39, 38, 38)"><b>Amount(in words) :</b> {{$info['absolute_cost_words']}}</div>
                                ...
                                <table style="border: 2px dotted {{$info['design_color']}}; margin-top: 16px; width: 100%"  role="presentation">
                        <tr>
                        <td>                                <span style="flex: 1 1 0%; padding-left: 8px; padding-right: 8px; font-size: 14px; text-transform: uppercase; color: {{$info['design_color']}}">Due Date:</span>                        </td>
                        <td>
                            </td><td style="text-align: right">                                        <span style="padding-top: 4px; padding-bottom: 4px; font-size: 20px; font-weight: 500; color: {{$info['design_color']}}">June 19,2022</span>                            </td>
                            <td style="text-align: center">                            <span style="flex: 1 1 0%; padding-top: 8px; padding-bottom: 8px; font-size: 14px; text-transform: uppercase; color: {{$info['design_color']}}">Amount Due:</span>                        </td>
                        <td style="text-align: right">                                    <span style="padding-left: 8px; padding-right: 8px; font-size: 20px; font-weight: 500; color: {{$info['design_color']}}">Rs.222.75</span>                            </td>
                        </tr>
                    </table>                   
           ...
           <tr> 
            ...
            <tr> 
                ...
                @endif 
                  ...
                  <div style="background-color: #e5e7eb; padding: 10px">
                    <table style="width: 100%"  role="presentation">

...
<div id="bookride" style="display: none;">
    <div id="appCapsule" class="full-height">
        ...
        <div id="app3" class="section tab-content mb-1">
                        ...
                        <div class="form-group basic">
                            <ul class="listview image-listview transparent flush">
                                ...
                                <li>
                                    <div class="item">
                                        <div class="in">
                                            <div><input type="date" value="{{$current_date}}" required name="date" class="form-control" id="date" placeholder="Select Date">
                                            </div>
                                ...
                                <li>
                                    <!--<div class="item" v-if="!shifts.length">
                                        <div class="in">

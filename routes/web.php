...
Route::group(['middleware' => array('auth', 'access')], function () {
    ...
    Route::get('/ratings', [App\Http\Controllers\HomeController::class, 'ratings'])->name('ratings');
    ...
    Route::any('/notifications/{ride_id?}', [App\Http\Controllers\HomeController::class, 'notifications'])->name('notifications');

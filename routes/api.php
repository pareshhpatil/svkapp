...
Route::get('booknetwork/count', [App\Http\Controllers\ApiController::class, 'bookNetworkCount']);


Route::middleware(['HostAccess'])->group(function () {
    Route::get('booknetwork/dashboard', [App\Http\Controllers\BookController::class, 'dashboard']);

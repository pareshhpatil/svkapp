...
class CreateInvoiceTravelParticularTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('invoice_travel_particular', function (Blueprint $table) {
    ...
    {
        Schema::dropIfExists('invoice_travel_particular');
    }
}

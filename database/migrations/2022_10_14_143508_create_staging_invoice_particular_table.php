...
class CreateStagingInvoiceParticularTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('staging_invoice_particular', function (Blueprint $table) {
            ...
            $table->string('product_expiry_date', 10)->nullable();
    ...
    {
        Schema::dropIfExists('staging_invoice_particular');
    }
}

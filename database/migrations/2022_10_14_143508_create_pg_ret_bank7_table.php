...
class CreatePgRetBank7Table extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('pg_ret_bank7', function (Blueprint $table) {
            ...
            $table->string('txMsg', 45)->nullable();
    ...
    {
        Schema::dropIfExists('pg_ret_bank7');
    }
}

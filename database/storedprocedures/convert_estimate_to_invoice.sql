...
SET @invoice_number='';
select template_id,merchant_id into @template_id,@merchant_id from payment_request where payment_request_id=_estimate_request_id;
...
@invoice_number,`estimate_number`,`payment_request_status`,`bill_date`,`due_date`,`expiry_date`,`narrative`,`franchise_id`,`vendor_id`,`is_active`,`bulk_id`,`unit_available`,`converted_request_id`,'',`notify_patron`,1,`webhook_id`,`short_url`,`has_custom_reminder`,`autocollect_plan_id`,`plugin_value`,`created_by`

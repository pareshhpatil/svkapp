...
EXECUTE stmt;
DEALLOCATE PREPARE stmt;
update temp_aging_summary b , customer u  set b.customer_name = concat(u.first_name,' ',u.last_name),b.customer_code=u.customer_code  where b.customer_id=u.customer_id ;

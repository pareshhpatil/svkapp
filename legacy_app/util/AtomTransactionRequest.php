...
Sentry\captureException($e);
            //
SwipezLogger::error(__CLASS__, '[EPG05]Error while InvokeATOMGateway sendInfo Error: ' . $e->getMessage());
        }
    }
...
Sentry\captureException($e);
            //
SwipezLogger::error(__CLASS__, '[EPG06]Error while InvokeATOMGateway xmltoarray Error: ' . $e->getMessage());
        }
    }

...
<div class="box-1" style="height:100px;">
    ...
    <div class="box-3">
        <p class="blue-big">&nbsp;Invoice Detail</p>
    ...
    <div class="table-1" style=" margin-top:0px;">
        <div class="row-a">
            ...
            <div class="box-twopp_">Particular Name</div> 
            <div class="box-twopp">Unit price (&#8377)</div>
            <div class="box-twopp">No of units   </div> 
        ...
        {section name=sec1 loop=$particular}
            {if {$particular[{$val}].value.3} > 0}
            {assign var=narrative value={{$particular[{$val}].value.4}|count_characters:true}}
                    <div class="row-b">

                        <div class="box-twopp_">{if {$particular[{$val}].value.0} != ''}{$particular[{$val}].value.0}{else}&nbsp;{/if}</div> 
                        ...
                        <div class="box-twopp">{if {$particular[{$val}].value.3} != ''}{$particular[{$val}].value.3}{else}&nbsp;{/if}</div> 
                        <div class="{if {$narrative}>20} masterTooltip {/if}box-twopp_ nnborder" {if {$narrative}>20}title="{$particular[{$val}].value.4}"{/if}>{if {$particular[{$val}].value.4} != ''} {if {$narrative}>20} {{$particular[{$val}].value.4}|substr:0:20}.... {else}{$particular[{$val}].value.4} {/if} {else}&nbsp;{/if}</div>  

                    </div> 
            {/if}
            {assign var=totalunits value=$totalunits+{$particular[{$val}].value.2}}
        ...
        {/section}
          ...
          <div class="row-b">
                ...
                <div class="box-twopp_ nnborder" style="font-weight: bold;">{$particularTotal}:</div> 
                <div class="box-twopp nnborder"> &nbsp; </div> 
                <div class="box-twopp nnborder"> {$totalunits} </div> 
                <div class="box-twopp nnborder" style="font-weight: bold;">&#8377 {$total}</div> 

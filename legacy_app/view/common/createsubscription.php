...
<div class="gn_temp">
    ...
    <input type="submit" id="bsubmit" class="complete1"  value="Save >" name="entitysubmit" />
...
<script>
            ...
            var date2 = document.getElementById('due_datetime').value;
            showDatePicker('start_date', date1);
            showDatePicker('due_datetime', date2);
            duedateSummery();
</script>

                        ...
                        <div id="pinnerDiv<?php echo $int; ?>">
                            <div class="row_three" ><input type="hidden" name="countrowtax"/>
                                ...
                                <div class=" box2">
                                  ...
                                  <img src="/images/minus1.gif" id="3" onclick="removenewdiv(<?php echo $int; ?>);calculatetax(<?php echo $int; ?>,<?php echo "'" . $swipez_fee_type . "','" . $swipez_fee_val . "','" . $pg_fee_type . "','" . $pg_fee_val . "','" . $pg_tax_val . "'"; ?>);" class="minus1" style="cursor:pointer;">
                        </div>
                            </div><!--End -->
                            <?php
                            $int++;

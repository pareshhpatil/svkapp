    ...
    <div class="container">
        <div class="col">
            <header class="text-center w-md-50 mx-auto mb-8">
                <h2 class="h1">Business website pricing</h2>
        ...
        <div class="row row-eq-height">
            <div class="col-md-6 my-5">
                <div class="card">
                    ...
                    <div class="card-body text-center">
                        <a class="btn btn-lg btn-block btn-outline-secondary" href="{$server_name}/merchant/register">Get Started
                            Now</a>
                    </div>
                </div>
            </div>
            <div class="col-md-6 my-5">
                <div class="card">
                    <div class="card-header p-4 text-center text-white bg-secondary">
                    ...
                    <div class="card-list">
                        <ul class="list-group text-center">
                            ...
                            <li class="list-group-item">Online payments starting at 0%</li>
                            <li class="list-group-item">Custom packages and plan pages</li>
                        </ul>
                    </div>
                    <div class="card-body text-center text-primary">
                        <a class="btn btn-lg btn-block btn-secondary text-white" href="https://go.swipez.in/webpkg1">Buy
                            now</a>
                    </div>
                </div>
            </div>

        ...
        <div class="row align-items-center">
            ...
            <div class="col-12 col-md-8 m-auto ml-lg-auto mr-lg-0 col-lg-6 pt-5 pt-lg-0 d-none d-lg-block">
                <img alt="Partner program to earn recurring revenue" class="img-fluid"
                    src="{$server_name}/assets/swipez-web/static/images/404.svg" />
            </div>
            <!-- for iPad and mobile -->
    ...
    <div class="container">
        <div class="row text-center">
            ...
            <div class="col-md-12 pt-4">
                <a class="btn btn-tertiary btn-lg text-white" href="{$server_name}">Homepage</a>
                <a class="btn btn-secondary btn-lg text-white" href="https://helpdesk.swipez.in/help">FAQ</a>
            </div>
        </div>
    </div>
</section>

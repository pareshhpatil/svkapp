...
<html lang="en">
    ...
    <head>
        ...
        <meta name="title" content="Patron Register">
...
<body class="login">
    ...
    <div class="content">
        ...
        <!-- BEGIN LOGIN FORM -->
        <form  action="/patron/register/saved" class="login-form" id="submit_form" method="post">
            <h3 class="form-title font-blue">Patron Registration</h3>
            <div class="form-group">
                <label class="control-label visible-ie8 visible-ie9">Your Name</label>
                <input class="form-control placeholder-no-fix" value="<?php echo $_POST['name']; ?>" maxlength="45" required="" type="text" placeholder="Name" name="name" /> </div>
            <div class="form-group">
                <label class="control-label visible-ie8 visible-ie9">Email ID</label>
            ...
            <div class="form-group">
                ...
                <input class="form-control placeholder-no-fix" pattern="^(\+[\d]{1,5}|0)?[1-9]\d{9}$" maxlength="15" type="text" required placeholder="Mobile No." value="<?php echo $_POST['mobile']; ?>" name="mobile" id="mobile"  /> </div>
            ...
            <div class="create-account ">
                <p>
                    <a href="<?php echo $this->server_name; ?>/merchant/register" class="uppercase">Register as a Merchant instead</a>
                </p>
            </div>
        </form>
        <!-- END LOGIN FORM -->

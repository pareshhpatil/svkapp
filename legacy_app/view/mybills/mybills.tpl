            ...
            <div class="portlet " style="max-width: 1000px;">
                ...
                <div class="portlet-body form">
                    ...
                    <form action="" method="post" id="template_create" class="form-horizontal form-row-sepe">
                        ...
                        <div class="form-body">
                            <div class="form-group">
                                <div class="col-md-12">
                                    <div class="col-md-6" style="text-align: right;"><label class="control-label" >Enter your Email ID / Mobile No. / Customer Code<span class="required">* </span></label></div>
                            ...
                            <div class="form-group">
                                <div class="col-md-12">
                                    <label class="control-label col-md-6">Captcha <span class="required">*
                                        </span></label>
                                    <div class="col-md-4">
                    ...
                    {if (empty($requestlist))}                
                        <div class="border panel-info" style="text-align: left; max-width: 900px;">

...
<li class="page-scroll">
<a href="{$server_name}/logout">Logout</a>
</li>  
{else}
<li class="page-scroll">
...
</div><div class="shop-index-carousel">
...
<a href="{$server_name}/privacy" class="color-white">Privacy Policy</a> | <a href="{$server_name}/terms" class="color-white">Terms & Conditions</a> |  <a href="{$server_name}/aboutus" class="color-white">About Us</a> | <a href="{$server_name}/contactus" class="color-white">Contact Us</a> | <a href="{$server_name}/work-from-home" class="color-white">Work From Home</a>| <a href="{$server_name}/sitemap" class="color-white">Sitemap</a> 
...
<p>&copy; {$current_year} OPUS Net Pvt. Handmade in Pune.</p>
</div>
</div>
</div>
</div>
...
<script src="/assets/global/plugins/smooth-scroll/smooth-scroll.js" ></script>
<script src="/assets/global/plugins/owl.carousel/owl.carousel.min.js" ></script>
<script src="/assets/global/plugins/cubeportfolio/cubeportfolio/js/jquery.cubeportfolio.min.js" ></script>
<script src="/assets/frontend/onepage2/scripts/portfolio.js" ></script>

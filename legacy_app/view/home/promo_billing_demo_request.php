...
<body class="page-header-fixed">
                                ...
                                <div class="col-md-12">
                                    <div class="row ">
                                        <div class="form-group">
                                            <div class="col-md-12">
                                                <input type="text" id="company_name" placeholder="Company name" value="<?php echo $_POST['company_name']; ?>" name="company_name" maxlength="45" required="" class="form-control">
                                    ...
                                    <div class="row">
                                        <div class="form-group">
                                            <div class="col-md-12">
                                                <input type="email" id="email" placeholder="Email ID" value="<?php echo $_POST['email']; ?>" name="email" <?php echo $this->HTMLValidatorPrinter->fetch("email"); ?> required="" class="form-control">
                                                <span class="help-block"> </span>
                                            </div>
                                        </div>
                                    </div>
    ...
    <h3 class="text-center"> Learn more about 
        <a href="https://www.swipez.in/billing-software">Billing Software</a>
    </h3>
    <!-- BEGIN INTRO SECTION -->

            ...
            <div class="row">
                <div class="col-md-6 coming-soon-content">
                    ...
                    <p>
                        ...
                        Our systems will be operational again by <?php echo $this->restore_time; ?>. Thank you for your understanding & continued patronage.
                    </p>
        ...
        <script>
            jQuery(document).ready(function () {
                ...
                $(function () {
                    ...
                    austDay = new Date(<?php echo $this->js_counter_time; ?>);

...
<body>
    {if $properties.hide_invoice_header==1}
        <div style="height: {if isset($properties.invoice_header_height)}{$properties.invoice_header_height}{else}150{/if}px;">
        </div>
    {else}
        ...
        {if !empty($tax)}
            ...
            <table autosize="1" width="100%" border="0" cellspacing="0" cellpadding="5"
                ...
                <thead>
                    <tr style="background-color: #E5E5E5 ;">
                        <th style="border-bottom: 1px solid #cbcbcb;border-right: 1px solid #cbcbcb;">Tax name</th>
                        <th style="border-bottom: 1px solid #cbcbcb;border-right: 1px solid #cbcbcb;"> Percentage </th>
                        <th style="border-bottom: 1px solid #cbcbcb;border-right: 1px solid #cbcbcb;">Applicable</th>
                        <th style="border-bottom: 1px solid #cbcbcb;border-right: 1px solid #cbcbcb;">Amount</th>
                ...
                <tbody>
                    ...
                    {foreach from=$tax item=v}
                        {if $v.tax_name!='' || $v.tax_amount>0}
                            <tr>
                                <td width="200" style="border-bottom: 1px solid #e2e2e2;border-right: 1px solid #e2e2e2;">
                                    {$v.tax_name}
                                </td>
                                <td width="100" style="border-bottom: 1px solid #e2e2e2;border-right: 1px solid #e2e2e2;">
                                    {$v.tax_percent}%
                                </td>
                                <td width="100" style="border-bottom: 1px solid #e2e2e2;border-right: 1px solid #e2e2e2;">
                                    {$v.applicable}
        ...
        <table autosize="1" style="margin:0 auto; font-family:Verdana, Arial;width: 800px;" align="center" width="800"
            ...
            <tr>
                <td style="color:#5b4d4b; line-height:22px;float: left; text-align:left; font-size:13px;width:100%;">
                    <table width="100%" border="0" cellspacing="0" cellpadding="5"
                        style="color:#5b4d4b;font-size: 13px;line-height: 15px;margin-right:20px;">
                        <tr>
                            <td>
                            ...
                            <td
                                style="color:#5b4d4b; line-height:22px; width: 300px; text-align:right; font-size:13px;">
                                {if $paid_amount>0}
                                ...
                                {/if}
                                {if $info.advance>0}
                                    <span style="float: right;padding-right: 15px;">Total Amount :
                                        {$info.currency_icon}{$info.grand_total+$info.advance|string_format:"%.2f"}</span>
                                    <br>
                                    <span style="float: right;padding-right: 15px;">Advance Received : {$info.currency_icon}
                                            {$info.advance|number_format:2:".":","}</span><br>
                                {/if}
                                {if $adjustment>0}
                                    <span style="float: right;padding-right: 15px;">Advance received :
                                        {$info.currency_icon}{$adjustment|number_format:2:".":","}</span>
                                    <br>

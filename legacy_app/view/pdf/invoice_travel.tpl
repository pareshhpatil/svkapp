                                        ...
                                        {foreach from=$properties.travel_section.column key=k item=v}
                                            {if $k=='amount'}
                                                <td style="text-align: right;border-top: 1px solid grey;"><b>
                                                        {$info.currency_icon} {$amount|number_format:2:".":","}</b></td>
                                            {/if}
                                            {if $k=='charge'}
                                                <td style="text-align: right;border-top: 1px solid grey;"><b>
                                                        {$info.currency_icon} {$charge|number_format:2:".":","}</b></td>
                                            {/if}
                                        {/foreach}
                                        <td style="border-top: 1px solid grey;"><b>{$info.currency_icon}
                                                {$total_amount|number_format:2:".":","}</b>
                                        </td>
                                    </tr>
                                </thead>
                            </table>
                                ...
                                <table autosize="1" width="100%" border="0" cellspacing="0" cellpadding="5"
                                    ...
                                    <tr>
                                        ...
                                        <td style="border-bottom: 1px solid #cbcbcb;text-align: right;border-right: 1px solid #cbcbcb;"
                                            class="col-md-2 td-c">
                                            <b>{$info.currency_icon} {$info.basic_amount|number_format:2:".":","}</b>
                                        </td>
                                    </tr>
                                    ...
                                    {if $paid_amount>0}
                                        <tr style="text-align: center;">
                                            ...
                                            <td
                                                style="border-bottom: 1px solid #cbcbcb;text-align: right;border-right: 1px solid #cbcbcb;">
                                                <b>{$info.currency_icon} {($paid_amount)|number_format:2:".":","}</b>
                                            </td>
                                        </tr>
                                    {/if}
                                    <tr style="text-align: center;{if !empty($info.design_color)}background-color:{$info.design_color};{/if}">
                                        ...
                                        <td
                                            ...
                                            <b>
                                                {$info.currency_icon}
                                                {($info.basic_amount+$tax_total+$previous_due-$adjustment)|number_format:2:".":","}</b>
                                        </td>
                                    </tr>
                                    {if $advance>0}
                                        <tr style="text-align: center;">

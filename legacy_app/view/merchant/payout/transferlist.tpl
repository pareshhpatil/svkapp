            ...
            <div class="portlet">
                ...
                <div class="portlet-body">
                    ...
                    <form class="form-inline" role="form" action="" method="post">
                        ...
                        <div class="form-group">
                            <select class="form-control input-sm select2me" name="bulk_id"
                                data-placeholder="Bulk upload file name">
                                <option value=""></option>
                            ...
                            <form action="" method="">
                                {foreach from=$list item=v}
                                    <tr>
                                        ...
                                        <td class="td-c">
                                            {{$v.created_date}|date_format:"%d %b %y %I:%M %p"}
                                        </td>
                                        <td class="td-c">
                                        ...
                                        <td class="td-c">
                                            ...
                                            {elseif $v.status==2}
                                                <label class="label label-sm label-default">Failed</label>
                                            {else}

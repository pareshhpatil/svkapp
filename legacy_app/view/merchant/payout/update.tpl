                            ...
                            <div class="row">
                                <div class="col-md-12">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-md-4">
                                            <input type="text" required readonly maxlength="100" name="vendor_name" class="form-control" value="{$det.vendor_name}">
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-md-4">
                                            <input type="email" required="" name="email" readonly id="f_email" maxlength="250" class="form-control" value="{$det.email_id}">
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        ...
                                        <div class="col-md-4">
                                            <input type="text" name="mobile" maxlength="12" readonly required {$validate.mobile} class="form-control" value="{$det.mobile}">
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        ...
                                        <div class="col-md-4">
                                            <textarea type="text" name="address" required readonly maxlength="250" class="form-control">{$det.address}</textarea>
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        ...
                                        <div class="col-md-4">
                                            <input type="text" required name="city" maxlength="45" readonly class="form-control" value="{$det.city}">
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        ...
                                        <div class="col-md-4">
                                            <input type="text" required name="state"  maxlength="45" readonly class="form-control" value="{$det.state}">
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        ...
                                        <div class="col-md-4">
                                            <input type="text" required name="zipcode"  maxlength="6" readonly class="form-control" value="{$det.zipcode}">
                                        </div>
                                    </div>
                                    <hr>
                                    <h3>Documents</h3>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-md-4">
                                            <input type="text" name="account_holder_name" readonly maxlength="100" class="form-control" value="{$det.bank_holder_name}">
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        ...
                                        <div class="col-md-4">
                                            <input type="text" name="account_number"  readonly maxlength="20" pattern="[0-9]"  class="form-control" value="{$det.bank_account_no}">
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        ...
                                        <div class="col-md-4">
                                            <input type="text" name="bank_name"  readonly maxlength="45" class="form-control" value="{$det.bank_name}">
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        ...
                                        <div class="col-md-4">
                                            <input type="text" name="account_type" readonly maxlength="45" class="form-control" value="{$det.account_type}">
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        ...
                                        <div class="col-md-4">
                                            <input type="text" name="ifsc_code" readonly  required=""  maxlength="20" class="form-control" value="{$det.ifsc_code}">
                                        </div>
                                    </div>
                                    <hr>

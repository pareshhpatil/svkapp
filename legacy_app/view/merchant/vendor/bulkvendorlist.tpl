                                    ...
                                    <td class="td-c">
                                        ...
                                        <div class="btn-group dropup">
                                            ...
                                            <ul class="dropdown-menu" role="menu">
                                                <li><a href="/merchant/vendor/bulkupdate/{$v.encrypted_id}"><i class="fa fa-edit"></i> Edit</a>
                                                </li>
                                                <li>
                                                    <a href="#basic" onclick="document.getElementById('deleteanchor').href = '/merchant/vendor/delete/{$v.encrypted_id}/staging'"  data-toggle="modal" ><i class="fa fa-times"></i> Delete</a>  
                                                </li>
                                            </ul>
                                        </div>
                                    </td>

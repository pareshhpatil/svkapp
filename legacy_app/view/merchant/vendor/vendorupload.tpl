...
<div class="page-content">
    ...
    <div class="row">
        ...
        <div class="col-md-12">
            ...
            <form action="/merchant/vendor/upload" enctype="multipart/form-data" method="post">
                {CSRF::create('vendor_upload')}
                <div class="">
                            ...
                            <div class="panel panel-default">
                                ...
                                <div id="collapse_1" class="panel-collapse in">
                                    <div class="panel-body">
                                        <p>Download the excel format for upload {$type} <a
                                                href="/merchant/vendor/download/{$type}"
                                                class="btn btn-xs blue">Download format</a></p>
                                        ...
                                        {if $v.status!='8'}
                                            <!-- <div class="visible-xs btn-group-vertical">
                                                ...
                                                {if {$v.status}=='1'}
                                                    ...
                                                    <span class="input-group-btn">
                                                        <a class="btn  btn-xs yellow" title="Re-upload sheet"
                                                            href="/merchant/vendor/reupload/{$type}/{$v.bulk_id}"><i
                                                    ...
                                                    <span class="input-group-btn">
                                                        <a class="btn  btn-xs yellow" title="View errors"
                                                            href="/merchant/vendor/error/{$v.bulk_id}" class="iframe"><i
                                                ...
                                                {else if {$v.status}=='3'}
                                                    ...
                                                    <span class="input-group-btn">
                                                        <a class="btn  btn-xs green" title="View vendors"
                                                            href="/merchant/vendor/bulklist/{$type}/{$v.bulk_id}"><i
                                                ...
                                                {else if {$v.status}=='5'}
                                                    <span class="input-group-btn">
                                                        <a class="btn  btn-xs green" title="View {$type}"
                                                            href="/merchant/vendor/{$vlist}/{$v.bulk_id}"><i
                                                                class="fa fa-users"></i></a>
                                                    </span>
                                                    <span class="input-group-btn">
                                                        <a class="btn  btn-xs blue" title="Download sheet"
                                            ...
                                            <div class="btn-group dropup">
                                                ...
                                                <ul class="dropdown-menu" role="menu">
                                                    {if {$v.status}=='1'}
                                                        ...
                                                        <li>
                                                            <a href="/merchant/vendor/reupload/{$type}/{$v.bulk_id}"><i
                                                    ...
                                                    {else if {$v.status}=='3'}
                                                        ...
                                                        <li><a href="/merchant/vendor/bulklist/{$type}/{$v.bulk_id}"><i
                                                                    class="fa fa-table"></i> View {$type}s</a>
                                                        </li>
                                                        <li>
                                                            <a href="/merchant/vendor/reupload/{$v.bulk_id}"><i
                                                                    class="fa fa-undo"></i> Re-upload sheet</a>
                                                        </li>
                                                        <li>
                                                            <a href="#basic"
                                                    ...
                                                    {else if {$v.status}=='5'}
                                                        <li>
                                                            {if $type=='beneficiary'}
                                                                <a href="/merchant/beneficiary/viewlist"><i class="fa fa-table"></i>
                                                                    View {$type}s</a>
                                                            {elseif $type=='payout'}
                                                                <a href="/merchant/payout/transaction"><i class="fa fa-table"></i> View
                                                                    {$type}s</a>
                                                            {else}

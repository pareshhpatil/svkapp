        ...
        <div class="col-md-12">
            {if isset($haserrors)}
                <div class="alert alert-danger">
                    ...
                    {if $type=='beneficiary'}
                        <a href="/merchant/vendor/downloadvalidSheet/{$bulk_id}/beneficiary" class="btn green" >Download valid records</a>
                    {/if}   
                    {if $type=='payout'}
                        <a href="/merchant/vendor/downloadvalidSheet/{$bulk_id}/payout" class="btn green" >Download valid records</a>
                    {/if}  
                </div>
            {/if}

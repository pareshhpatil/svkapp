        ...
        <div class="col-md-12">
            ...
            <div class="portlet light bordered">
                <div class="portlet-body form">
                    ...
                    <form action="/merchant/coveringnote/saveupdate" method="post" id="submit_form" class="form-horizontal form-row-sepe">
                         {CSRF::create('coveringnote_update')}
                        <div class="form-body">
                            ...
                            <div class="row">
                                <div class="col-md-12">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-md-4">
                                            <input type="text" required name="template_name" {$validate.name} class="form-control" value="{$detail.template_name}">
                                        </div>
                                    </div>
                                    <div class="form-group">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-md-4">
                                            <input type="text" required maxlength="100" name="subject" class="form-control" value="{$detail.subject}">
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        ...
                                        <div class="col-md-4">
                                            <input type="text" required maxlength="20"  name="invoice_label" class="form-control"  value="{$detail.invoice_label}">
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        ...
                                        <div class="col-md-4">
                                            <input type="checkbox" {if $detail.pdf_enable==1} checked=""{/if} name="pdf_enable" value="1" class="make-switch" data-on-text="&nbsp;Enabled&nbsp;&nbsp;" 
                            ...
                            <div class="row">
                                <div class="col-md-12">
                                    <div class="pull-right">
                                        <a href="/merchant/coveringnote/viewlist" class="btn btn-link">Cancel</a>
                                        <input type="submit" value="Save" class="btn blue"/>
                                        <input type="hidden" id="emailidd" name="covering_id" value="{$detail.covering_id}" />
                                        <input type="hidden" id="emailidd" name="email_id" value="{$merchant_email}" />
                                    </div>
                                    <!--<a data-toggle="modal" title="Add new customer" href="#custom" class="btn green"><i class="fa fa-send"></i> Test Mail</a>-->
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="portlet-body form">
                            <div class="form-body">
                                ...
                                <div class="row">
                                    <div class="col-md-12">
                                        <div class="form-group">
                                            <label class="control-label col-md-4">Email ID<span class="required">* </span></label>
                                            <div class="col-md-4">
                                ...
                                <div class="row">
                                    <div class="col-md-12">
                                        <div class="form-group">
                                            <label class="control-label col-md-4">Captcha<span class="required">* </span></label>
                                            <div class="col-md-4">

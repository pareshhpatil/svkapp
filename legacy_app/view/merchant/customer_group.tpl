...
<div class="page-content">
    ...
    <div class="row">
        ...
        <div class="col-md-8">
            ...
            <form class="form-inline" id="customergroup" action="/merchant/customer/savecustomergroup" method="post" role="form">
                    ...
                    <div class="portlet-body ">
                        ...
                        <div class="form-group">
                            ...
                            <div class="input-group">
                                ...
                                <select name="group_id" id="cat_drop" required="" class="form-control" data-placeholder="Select..." aria-required="true">
                                ...
                                <span class="input-group-btn">
                                    <a data-toggle="modal" title="Add new customer" href="#custom" class="btn green"><i class="fa fa-plus"></i> Add new</a>
                                </span>
                            </div>
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <button type="submit" onclick="return save_customer_group();" class="btn green">Add to Group</button>
                        </div>
                                        ...
                                        <tbody>
                                            {foreach from=$customer_group item=v}
                                                <tr>
                                                    ...
                                                    <td class="td-c">
                                                        <a href="#basic" onclick="document.getElementById('deleteanchor').href = '/merchant/customer/deletegroup/{$v.link}'" data-toggle="modal" class="btn btn-xs red"><i class="fa fa-times"></i> Delete </a>
                                                    </td>
                        ...
                        <div class="portlet-body form">
                            <div class="form-body">
                                ...
                                <div class="row">
                                    <div class="col-md-12">
                                        <div class="form-group">
                                            <label class="control-label col-md-4">Group name<span class="required">* </span></label>
                                            <div class="col-md-4">
                                                <input type="text" id="category_name" maxlength="45" name="group_name" value="" class="form-control">
                                            </div>
                                        </div>
                                    </div>
                                </div>

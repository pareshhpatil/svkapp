...
<div class="page-content">
    ...
    <div class="row">
        <div class="col-md-12">
            <form name="addslot" action="/merchant/bookings/savecalendarv2" method="post" enctype="multipart/form-data">
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-9">
                                    ...
                                    <div class="">
                                        ...
                                        <div class="row">
                                            <div class="col-md-12">
                                                <input type="hidden" id="package_number" name="package_number[]"
                                                    value="1">
                                                <div class="row">
                                                    <div class="col-md-5">
                                                        <h3>Package</h3>
                                                    ...
                                                    <div class="col-md-7">
                                                        <div class="form-group">
                                                            <div class="col-md-12">
                                                                Package Name
                                                                <input type="text" required name="package_name1"
                                                                    id="package_name1"
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="col-md-7">
                                                        <div class="form-group">
                                                            <div class="col-md-12">
                                                                Package Description
                                                                <textarea name="package_desc1" id="package_desc1"
                                ...
                                <div class="col-md-2">
                                    ...
                                    <a style="display:none;" href="javascript:;" onclick="removeBookingPackage(1)"
                                                    ...
                                                    <div class="row" style="
                                                        ...
                                                        <div class="col-md-10">
                                                            ...
                                                            <textarea class="form-control" id="slot_description11"
                                                                name="slot_description1[]" maxlength="200"></textarea>

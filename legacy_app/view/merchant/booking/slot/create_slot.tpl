...
<div class="page-content">
    ...
    <div class="row">
        <div class="col-md-12">
            <form name="addslot" action="/merchant/bookings/saveslots" method="post">
                {CSRF::create('booking_slot_save')}
                ...
                <div class="portlet">
                    <div class="portlet-body">
                        <div class="row">
                            ...
                            <div class="col-md-9">
                                ...
                                <div class="">
                                    ...
                                    <div class="row">
                                        <div class="col-md-12">
                                            <input type="hidden" id="package_number" name="package_number[]" value="1">
                                            <div class="row">
                                                <div class="col-md-5">
                                                    <h3>Package</h3>
                                                </div>
                                                <div class="col-md-7">
                                                    <div class="form-group">
                                                        <div class="col-md-6">
                                                            <select name="package_id" required id="packages"
                                                                onchange="setpackageonslotupdate(this.value)"
                                                                class="form-control"
                                                                data-placeholder="Select packages...">
                                                                <option value="">Select package...</option>
                                                                {foreach from=$packages item=v}
                                                                    {if $package_id==$v.package_id}
                                                                        <option selected value="{$v.package_id}">
                                                                            {$v.package_name}</option>
                                                                        {$court_name=$v.package_name}
                                                                    {else}
                                                                        <option value="{$v.package_id}"> {$v.package_name}
                                                                        </option>
                                                                    {/if}
                                                                {/foreach}
                                                            </select>
                        ...
                        <div id="showslotbookings" style="display:none;">
                            <div class="row">
                                <div class="col-md-1"></div>
                                <div class="col-md-9">
                                    <div class="row">
                                            ...
                                            <div class="form-group">
                                                <div class="col-md-6">
                                                    ...
                                                    <input class="form-control form-control-inline date-picker" readonly
                                                        type="text" required name="slot_date_from1" id="slot_date_from1"
                                                ...
                                                <div class="col-md-6">
                                                    ...
                                                    <div class="input-group">
                                                        <input readonly onchange="showweekdays(this.value);"
                                                            ...
                                                            type="text"
                                                            style="background-color: #ffffff;cursor: pointer;"
                                                            name="slot_date_to1" id="slot_date_to1" autocomplete="off"
                                                            data-date-format="dd M yyyy" placeholder="To date" />
                                                ...
                                                <div class="col-md-12">
                                                    <div class="weekDays-selector">
                                                        <input type="checkbox" id="weekday-mon1" class="weekday"
                                                            onchange="dateCheckboxclicked()" name="slot_weekday1[]"
                                                            value="1" checked />
                                                        <label id="weekday-mon1-div" for="weekday-mon1">Mon</label>

                                                        <input type="checkbox" id="weekday-tue1"
                                                            onchange="dateCheckboxclicked()" class="weekday"
                                    ...
                                    <div class="row">
                                        <div class="col-md-5">
                                            <h3>Slot Duration
                                                <button class="popovers btn btn-link dropdown-toggle button-on-hover"
                                                    data-container="body" data-placement="top" data-trigger="hover"
                                        ...
                                        <div class="col-md-7">
                                            <div class="form-group">
                                                <div class="col-md-6">
                                                    ...
                                                    time slots
                                                    <select name="slot_interval1" class="form-control" required
                                                        id="slot_interval1" onchange="showCustom(this.value,1)">
                                            ...
                                            <div class="col-md-7">
                                                <div class="form-group">
                                                    <div class="col-md-6">
                                                        ...
                                                        <input type="text" name="slot_interval_minutes1"
                                                            id="slot_interval_minutes1" style="width: 300px;"
                                            ...
                                            <div class="col-md-7">
                                                <div class="form-group">
                                                    <div class="col-md-6">
                                                        ...
                                                        <input type="number" min="0" name="slot_pause1" id="slot_pause1"
                                                            style="width: 300px;"
                                                            class="form-control form-control-inline">
                                                    </div>
                                                </div>
                                                ...
                                                <div class="portlet-body">
                                                    <div class="table-scrollable">
                                                        <table class="table table-bordered table-hover"
                                                            id="particular_table" style="width: 300px;">
                                                            <thead>
                                                                <tr>
                                                                    <th class="td-c">
                                                                        From
                                    ...
                                    <div class="row" style="display: none;" id="tyfromto1">
                                        ...
                                        <div class="col-md-7">
                                            <div class="portlet-body">
                                                <div class="table-scrollable">
                                                    <table class="table table-bordered table-hover"
                                                        id="particular_table" style="width: 290px;">
                                                        <thead>
                                                            <tr>
                                                                <th class="td-c">
                                                                    From
                                                        ...
                                                        <tbody id="new_duration1">
                                                            <tr>
                                                                <td style="width: 405px;">
                                                                    <div class="input-group">
                                                                        <select class="form-control input-sm"
                                                                            ...
                                                                            id="slot_interval_custom_from_hour1"
                                                                            style="width:85px">
                                                                            <option value="">
                                                                                Hour
                                                                            </option>
                                                                        ...
                                                                        <select class="form-control input-sm"
                                                                            ...
                                                                            id="slot_interval_custom_from_minute1"
                                                                            style="width:90px">
                                                                        ...
                                                                        <select class="form-control input-sm"
                                                                            ...
                                                                            id="slot_interval_custom_from_ampm1"
                                                                            style="width:85px">
                                                                            <option value="am">
                                                                                am
                                                                            </option>
                                                                ...
                                                                <td style="width: 405px;">
                                                                    <div class="input-group">
                                                                        <select class="form-control input-sm"
                                                                            ...
                                                                            id="slot_interval_custom_to_hour1"
                                                                            style="width:85px">
                                                                            <option value="">
                                                                                Hour
                                                                            </option>
                                                                        ...
                                                                        <select class="form-control input-sm"
                                                                            ...
                                                                            id="slot_interval_custom_to_minute1"
                                                                            style="width:90px">
                                                                        ...
                                                                        <select class="form-control input-sm"
                                                                            ...
                                                                            id="slot_interval_custom_to_ampm1"
                                                                            style="width:85px">
                                                                            <option value="am">
                                                                                am
                                                                            </option>
                                                                ...
                                                                <td style="width: 30px;">
                                                                    <a onclick="AddDurationrow(1);"
                                                                        class="btn btn-sm green"><i class="fa fa-plus">
                                                                        </i></a>
                                                                </td>
                                                            </tr>
                                                        </tbody>
                                        ...
                                        <div class="col-md-7">
                                            ...
                                            <div class="form-group">
                                                <div class="col-md-3">
                                                    ...
                                                    <input class="form-control form-control-inline" required="" min="0"
                                                        type="number" name="unitavailable1" value="0"
                                                        id="unitavailable1">
                                            ...
                                            <div class="form-group">
                                                <div class="col-md-3">
                                                    ...
                                                    <input type="number" min="1"
                                                        ...
                                                        name="min_seat1" id="min_seat1" value="1" required
                                                        class="form-control form-control-inline">
                                                ...
                                                <div class="col-md-3">
                                                    ...
                                                    <input type="number" min="1" name="max_seat1" id="max_seat1"
                                                        value="1" required="" class="form-control form-control-inline">
                                                    <span class="help-block">
                                                    </span>
                                                </div>
                                    ...
                                    <div class="row">
                                        ...
                                        border-radius: 15px;">
                                                        <div class="col-md-10">
                                                            ...
                                                            <textarea class="form-control" id="slot_description11"
                                                                name="slot_description1[]" maxlength="500"></textarea>
                                                            <h4>Cost <span class="required">*
                                                                </span>
                                                            </h4>
                                                            <input type="number" step="0.01" min="0" required
                                                                name="slot_price1[]" id="slot_price11"
                                                                class="form-control form-control-inline">
                                                            <h4>Primary Slot ?</h4>
                                                            <input type="checkbox" value="1"
                                                                onchange="is_primarySlot(this.checked,'slot_isprimary11')"
                                                                id="isprimary_checkbox11">
                                                            <input type="hidden" value="0" name="slot_isprimary1[]"
                                                                id="slot_isprimary11">
                                                        </div>
                                                        <div class="col-md-2">
                                                            <a href="javascript:;" onclick="addSlots(1,1)"
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-5">
                                ...
                                <a href="/merchant/bookings/calendars" class="btn btn-default">Cancel</a>
                            </div>
                        </div>
                    </div>
                </div>

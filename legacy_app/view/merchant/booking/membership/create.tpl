        ...
        <div class="col-md-12">
            ...
            <div class="portlet light bordered">
                <div class="portlet-body form">
                    ...
                    <form action="/merchant/bookings/savemembership" method="post" id="submit_form" class="form-horizontal form-row-sepe">
                       {CSRF::create('booking_membership_save')}
                        <div class="form-body">
                            ...
                            <div class="row">
                                <div class="col-md-12">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-md-4">
                                            <input type="text" required name="title" maxlength="45" {$validate.name} class="form-control" value="{$post.title}">
                                        </div>
                                    </div>
                                    <div class="form-group">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-md-4">
                                            <input type="number" min="1" max="1000" required name="days" class="form-control" value="{$post.days}">
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        ...
                                        <div class="col-md-4">
                                            <input type="number" min="1" step="0.01" required name="amount" class="form-control" value="{$post.amount}">
                                        </div>
                                    </div>
                                    <div class="form-group">

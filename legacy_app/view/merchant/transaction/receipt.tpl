    ...
    <div class="row no-margin">
        <div class="col-md-12">
            ...
            <div class="portlet light bordered">
                                    ...
                                    <table class="table table-condensed table-bordered "
                                        ...
                                        {foreach from=$booking_details item=v}
                                            ...
                                            <tr>
                                                ...
                                                <td style="width: 30%;">{$v.package_name} - {$v.slot_title}</td>
                ...
                {if {$isGuest} =='1'}
                    <hr />
                    <p>Track your payments by registering on <a href="/patron/register">Swipez - Register.</a> <img
                            src="/assets/admin/layout/img/logo.png" class="img-responsive pull-right powerbyimg"

                            ...
                            <div class="panel panel-default">
                                ...
                                <div id="collapse_1" class="panel-collapse in">
                                    <div class="panel-body">
                                        <p>Download the excel format for upload transaction <a
                                                href="/merchant/transaction/download" class="btn btn-xs blue">Download
                                                format</a></p>
                                        <p>In the downloaded excel sheet enter transaction details. Use column names
                            ...
                            {foreach from=$bulklist item=v}
                                <tr>
                                    ...
                                    <td class="td-c">
                                        {$link=''}
                                        {if $v.status=='1'}
                                            {$link='/merchant/transaction/error/'}
                                        {else if {$v.status}=='3'}
                                            {$link='/merchant/transaction/bulklist/'}
                                        {else if {$v.status}=='4'}
                                            {$link='/merchant/transaction/bulklist/'}
                                        {else if {$v.status}=='5'}
                                            {$link='/merchant/transaction/viewlist/transaction/'}
                                        {/if}
                                        {if $link!=''}
                                        ...
                                        {if $v.status!='8'}
                                            <!-- <div class="visible-xs btn-group-vertical">
                                                ...
                                                {if {$v.status}=='1'}
                                                    ...
                                                    <span class="input-group-btn">
                                                        <a class="btn  btn-xs yellow" title="Re-upload sheet"
                                                            href="/merchant/transaction/reupload/{$v.bulk_id}"><i
                                                                class="fa fa-undo"></i></a>
                                                    </span>
                                                    <span class="input-group-btn">
                                                        <a class="btn  btn-xs red" title="Delete sheet" href="#basic"
                                                            onclick="document.getElementById('deleteanchor').href = '/merchant/bulkupload/delete/{$v.bulk_id}/transaction'"
                                                            data-toggle="modal"><i class="fa fa-times"></i></a>
                                                    </span>
                                                    <span class="input-group-btn">
                                                        <a class="btn  btn-xs yellow" title="View errors"
                                                            href="/merchant/transaction/error/{$v.bulk_id}" class="iframe"><i
                                                ...
                                                {else if {$v.status}=='3'}
                                                    ...
                                                    <span class="input-group-btn">
                                                        <a class="btn  btn-xs green" title="View transactions"
                                                            href="/merchant/transaction/bulklist/{$v.bulk_id}"><i
                                                    ...
                                                    <span class="input-group-btn">
                                                        <a class="btn  btn-xs green" title="Approve transaction" href="#sendinvoice"
                                                            onclick="document.getElementById('sendanchor').href = '/merchant/bulkupload/send/{$v.bulk_id}/transaction'"
                                                ...
                                                {else if {$v.status}=='5'}
                                                    <span class="input-group-btn">
                                                        <a class="btn  btn-xs green" title="View transactions"
                                                            href="/merchant/transaction/viewlist/transaction/{$v.bulk_id}"><i
                                                                class="fa fa-users"></i></a>
                                                    </span>
                                                    <span class="input-group-btn">
                                                        <a class="btn  btn-xs blue" title="Download sheet"
                                            ...
                                            <div class="btn-group dropup">
                                                ...
                                                <ul class="dropdown-menu" role="menu">
                                                    {if {$v.status}=='1'}
                                                        <li>
                                                            <a href="/merchant/bulkupload/download/{$v.bulk_id}/transaction"><i
                                                                    class="fa fa-download"></i> Download sheet</a></span>
                                                        </li>
                                                        <li>
                                                            <a href="/merchant/transaction/reupload/{$v.bulk_id}"><i
                                                    ...
                                                    {else if {$v.status}=='3'}
                                                        ...
                                                        <li><a href="/merchant/transaction/bulklist/{$v.bulk_id}"><i
                                                                    class="fa fa-table"></i> View transactions</a>
                                                        </li>
                                                        <li>
                                                            <a href="/merchant/transaction/reupload/{$v.bulk_id}"><i
                                                                    class="fa fa-undo"></i> Re-upload sheet</a>
                                                    ...
                                                    {else if {$v.status}=='5'}
                                                        <li>
                                                            <a href="/merchant/transaction/viewlist/transaction/{$v.bulk_id}"><i
                                                                    class="fa fa-table"></i> View transactions</a>
                                                        </li>
                                                        <li>
                                                            <a href="/merchant/bulkupload/download/{$v.bulk_id}/transaction"><i
                        ...
                        <div class="modal-dialog">
                            <div class="modal-content">
                                <div class="modal-header">
                                    <button type="button" class="close" data-dismiss="modal"
                                        aria-hidden="true"></button>
                                    <h4 class="modal-title">Save Excel transactions</h4>
                                </div>
                                <div class="modal-body">

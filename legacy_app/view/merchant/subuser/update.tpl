                                ...
                                <div class="row">
                                    <div class="col-md-12">
                                        <div class="form-group">
                                            ...
                                            <div class="col-md-4">
                                                <input type="text" name="supplier_company_name" {$validate.name} class="form-control" value="{$supplier.supplier_company_name}">
                                            </div>
                                        </div>
                                        <div class="form-group">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-md-3">
                                                <input type="text" name="mobile2" {$validate.mobile} class="form-control" value="{$supplier.mobile2}">
                                            </div>
                                        </div>
                                        <div class="form-group">

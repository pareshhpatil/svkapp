        ...
        <div class="col-md-12">
            ...
            <div class="portlet light bordered">
                <div class="portlet-body form">
                    ...
                    <form action="/merchant/subuser/roleupdatesaved" method="post" id="submit_form" class="form-horizontal form-row-sepe">
                       {CSRF::create('role_update')}
                        <div class="form-body">
                                                    ...
                                                    {foreach from=$list item=v}
                                                        <tr>
                                                            ...
                                                            <td class="td-c">
                                                                ...
                                                                {else}
                                                                    <input  {$v.view.checked} name="view[]" value="{$v.controller_id}" type="checkbox">
                                                                {/if}
                                                            ...
                                                            <td class="td-c">
                                                                ...
                                                                {else}
                                                                    <input  {$v.edit.checked} name="edit[]" value="{$v.controller_id}" type="checkbox">
                                                                {/if}
                                                            ...
                                                            <td class="td-c">
                                                                ...
                                                                {else}
                                                                    <input  {$v.delete.checked} name="delete[]" value="{$v.controller_id}" type="checkbox">
                                                                {/if}

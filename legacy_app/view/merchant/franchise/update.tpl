        ...
        <div class="col-md-12">
            ...
            <div class="portlet light bordered">
                <div class="portlet-body form">
                    ...
                    <form action="/merchant/franchise/saveupdate" method="post" id="submit_form"
                        class="form-horizontal form-row-sepe">
                        {CSRF::create('franchise_update')}
                        <div class="form-body">
                            ...
                            <div class="row">
                                <div class="col-md-12">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-md-4">
                                            <input type="text" required readonly maxlength="100" name="franchise_name"
                                                {$validate.name} class="form-control" value="{$det.franchise_name}">
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-md-4">
                                            <input type="email" maxlength="250" id="f_email" name="email"
                                                class="form-control" value="{$det.email_id}">
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        ...
                                        <div class="col-md-4">
                                            <input type="text" maxlength="12" required {$validate.mobile} name="mobile"
                                                class="form-control" value="{$det.mobile}">
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        ...
                                        <div class="col-md-4">
                                            <textarea type="text" required name="address" maxlength="250"
                                                class="form-control">{$det.address}</textarea>
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        ...
                                        <div class="col-md-4">
                                            <input type="text" maxlength="20" name="gst" {$validate.gst_number}
                                                class="form-control" value="{$det.gst_number}">
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        ...
                                        <div class="col-md-4">
                                            <input type="text" maxlength="20" name="pan" {$validate.pan}
                                                class="form-control" value="{$det.pan}">
                                        </div>
                                    </div>
                                    <div class="form-group">
                                    ...
                                    {if $food_franchise==true || $non_brand_food_franchise==true}
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-md-4">
                                                <input type="text" readonly required name="franchise_code"
                                                    class="form-control" value="{$det.franchise_code}">
                                            </div>
                                        </div>
                                        <div class="form-group">
                                            ...
                                            <div class="col-md-4">
                                                <input type="number" required step="0.01" max="100"
                                                    ...
                                                    value="{$det.franchise_fee_commission}">
                                            </div>
                                        </div>
                                        <div class="form-group">
                                            ...
                                            <div class="col-md-4">
                                                <input type="number" required step="0.01" max="100"
                                                    ...
                                                    value="{$det.franchise_fee_waiver}">
                                            </div>
                                        </div>
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="col-md-4">
                                                    <input type="number" required step="0.01" max="100"
                                                        ...
                                                        value="{$det.non_brand_fee_commission}">
                                                </div>
                                            </div>
                                            <div class="form-group">
                                                ...
                                                <div class="col-md-4">
                                                    <input type="number" required step="0.01" max="100"
                                                        ...
                                                        value="{$det.non_brand_fee_waiver}">
                                                </div>
                                            </div>
                                        {/if}
                                                <div class="form-group">
                                                    ...
                                                    <div class="col-md-4">
                                                        <input type="number" required step="0.01" max="100" name="due_penalty"
                                                            class="form-control" value="{$det.penalty_percentage}">
                                                    </div>
                                                </div>
                                                <div class="form-group">
                                                    ...
                                                    <div class="col-md-4">
                                                        <input type="number" required step="0.01" name="min_penalty"
                                                            class="form-control" value="{$det.penalty_min_amt}">
                                                    </div>
                                                </div>
                                                <div class="form-group">
                                                    ...
                                                    <div class="col-md-4">
                                                        <input type="number" required step="0.01" name="default_sale"
                                                            class="form-control" value="{$det.default_sale}">
                                                        <input type="hidden" name="food_franchise" value="1">
                                                        <input type="hidden" name="customer_id" value="{$det.customer_id}">
                                                    </div>
                                                </div>
                                            {/if}
                                            <hr>
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="col-md-4">
                                                    <input type="text" maxlength="100" name="contact_person_name2"
                                                        ...
                                                        value="{$det.contact_person_name2}">
                                                </div>
                                            </div>
                                            <div class="form-group">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="col-md-4">
                                                    <input type="text" maxlength="12" name="mobile2" {$validate.mobile_number}
                                                        class="form-control" value="{$det.mobile2}">
                                                </div>
                                            </div>
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="col-md-4">
                                                    <input type="text" readonly maxlength="100" name="account_holder_name"
                                                        {$validate.name_text} class="form-control"
                                                        value="{$det.bank_holder_name}">
                                                </div>
                                            </div>
                                            <div class="form-group">
                                                ...
                                                <div class="col-md-4">
                                                    <input type="text" readonly maxlength="20" name="account_number"
                                                        pattern="[0-9]" class="form-control" value="{$det.bank_account_no}">
                                                </div>
                                            </div>
                                            <div class="form-group">
                                                ...
                                                <div class="col-md-4">
                                                    <input type="text" readonly maxlength="45" name="bank_name"
                                                        {$validate.name_text} class="form-control" value="{$det.bank_name}">
                                                </div>
                                            </div>
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="col-md-4">
                                                    <input type="text" readonly maxlength="20" name="account_type"
                                                        class="form-control" value="{$det.account_type}">
                                                </div>
                                            </div>
                                            <div class="form-group">
                                                ...
                                                <div class="col-md-4">
                                                    <input type="text" readonly maxlength="20" name="ifsc_code"
                                                        {$validate.name_text} class="form-control" value="{$det.ifsc_code}">
                                                </div>
                                            </div>
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="col-md-2">
                                                    <input type="checkbox" {if $enable_online_settlement==0} disabled="" {/if}
                                                        id="issupplier" {if $det.online_pg_settlement==1} checked {/if}
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <div class="col-md-2">
                                                        <select name="commision_type"
                                                            ...
                                                            <option {if $det.commision_type==1} selected {/if} value="1">
                                                                Percentage</option>
                                                            <option {if $det.commision_type==2} selected {/if} value="2">Fixed
                                                            </option>
                                                        </select>
                                                    </div>
                                                </div>
                                                <div class="form-group" {if $det.commision_type==2} style="display: none;" {/if}
                                                    id="commision_per_div">
                                                    ...
                                                    <div class="col-md-2" id="commision_per_div">
                                                        <input type="number" max="100" step="0.01" name="commision_percent"
                                                            ...
                                                            value="{$det.commission_percentage}">
                                                    </div>
                                                </div>
                                                <div class="form-group" id="commision_amt_div" {if $det.commision_type!=2}
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <div class="col-md-2">
                                                        <select name="settlement_type" class="form-control">
                                                            <option {if $det.settlement_type==1} selected {/if} value="1">Manual
                                                            </option>
                                                            <option {if $det.settlement_type==2} selected {/if} value="2">
                                                                Automatic</option>
                                                        </select>
                                                    </div>
                                                </div>

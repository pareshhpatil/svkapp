...
class SSP
{
    ...
    static function simple($request, $conn, $column_name, $table, $primaryKey, $columns)
    {
        ...
        $data = self::sql_exec(
            $db,
            $bindings,
            "call report_payment_received('" . self::$merchant_id . "','" . self::$from_date . "',"
                . "'" . self::$to_date . "','" . self::$customer_id . "','" . $column_name . "','" . $_SESSION['_where'] . "','" . $where . "','" . $order . "','" . $limit . "');"
        );

...
class SSP {
    ...
    static function simple($request, $conn, $column_name, $table, $primaryKey, $columns) {
        ...
        $data = self::sql_exec($db, $bindings, "call report_payment_transaction_tdr('" . self::$merchant_id . "','" . self::$from_date . "',"
                        . "'" . self::$to_date . "','" . $column_name . "','" . self::$franchise_id . "','" . $where . "','" . $order . "','" . $limit . "');"
        );

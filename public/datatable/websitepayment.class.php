...
class SSP {
    ...
    static function simple($request, $conn, $column_name, $table, $primaryKey, $columns) {
        ...
        $data = self::sql_exec($db, $bindings, "call get_merchant_xwaytransaction('" . self::$merchant_id . "','" . self::$from_date . "','" . self::$to_date . "','" . self::$status . "'," . self::$franchise_id . "," . self::$type . ",'" . $where . "','" . $order . "','" . $limit . "');"
        );

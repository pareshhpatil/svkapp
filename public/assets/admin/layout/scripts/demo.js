...
var Demo = function() {
    ...
    var handleTheme = function() {
        ...
        if ($('.sidebar-pos-option').attr("disabled") === false) {
            $('.sidebar-pos-option', panel).val(Swipez.isRTL() ? 'right' : 'left');
        }
        ...
        var setColor = function(color) {
            var color_ = (Swipez.isRTL() ? color + '-rtl' : color);
    ...
    var setThemeStyle = function(style) {
        ...
        file = (Swipez.isRTL() ? file + '-rtl' : file);

        $('#style_components').attr("href", Swipez.getGlobalCssPath() + file + ".css");

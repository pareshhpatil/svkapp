...
function addnewRow() {
    ...
    task_number='';
    if (_('request_type').value == 2) {
        task_number='<td style="vertical-align: middle; " class="td-c onhover-border "><span style="width: 100%;display: block;" id="span_task_number' + id + '"><span style="width: 100%;display: block;" onclick="setInput(' + id + ','+"'"+'task_number'+"+"+')"><input type="text" class="form-control input-sm amtbox" id="task_number' + id + '" name="task_number[]" value=""></span></span></td>';
    }
    id = id + 1;

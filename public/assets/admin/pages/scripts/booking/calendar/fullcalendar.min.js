 ...
 ue.mixin({
  ...
  fgSegHtml: function(t, e) {
   var n, i, r = this.view,
    ...
    d = "";
    //alert(s.abc);
   return u.unshift("fc-day-grid-event", "fc-h-event"), t.isStart && (n = this.getEventTimeText(s), n && (d = '<span class="fc-time">' + tt(n) + "</span>")), i = '<span class="fc-title">' + (tt(s.title || "") || "&nbsp;") + "<br><br> Book Now</span>", '<a class="' + u.join(" ") + '"' + (s.url ? ' href="' + tt(s.url) + '"' : "") + (c ? ' style="' + c + '"' : "") + '><div onclick="selectSlot('+"'"+s.year+'Space'+s.month+'Space'+s.day+"',"+s.calendar_id+');" class="fc-content">' + (this.isRTL ? i + " " + d : d + " " + i) + "</div>" + (l ? '<div class="fc-resizer fc-start-resizer" />' : "") + (a ? '<div class="fc-resizer fc-end-resizer" />' : "") + "</a>"
  },
 ...
 var de = Ot.View = ct.extend(Jt, te, {
   ...
   buildGotoAnchorHtml: function(e, n, i) {
    ...
    return t.isPlainObject(e) ? (r = e.date, s = e.type, o = e.forceOff) : r = e, r = Ot.moment(r), l = {
     ...
     type: s || "day"
    }, "string" == typeof n && (i = n, n = null), n = n ? " " + it(n) : "", i = i || "", !o && this.opt("navLinks") ? "<a" + n + ' >' + i + "</a>" : "<span" + n + ">" + i + "</span>"
   },
   setElement: function(t) {

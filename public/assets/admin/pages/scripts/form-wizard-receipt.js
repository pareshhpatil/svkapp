        ...
        init: function () {
            ...
            form.validate({
                ...
                messages: {// custom messages for radio buttons and checkboxes
                    'confirm': {
                        required: "Please confirm you have completed step #1 by clicking the checkbox"
                    }
                },
                ...
                success: function (label) {
                    if (label.attr("for") == "gender" || label.attr("for") == "confirm") { // for checkboxes and radio buttons, no need to show OK icon
                        label
                                .closest('.form-group').removeClass('has-error').addClass('has-error');
            ...
            var handleTitle = function (tab, navigation, index) {
                ...
                if (current == 1) {
                    ...
                    $('#form_wizard_1').find('.button-next').html('Continue <i class="m-icon-swapright m-icon-white"></i>');
                ...
                if (current == 2) {
                    $('#form_wizard_1').find('.button-next').show();
                    $('#form_wizard_1').find('.button-next').html('Acknowledge & Show Receipt <i class="m-icon-swapright m-icon-white"></i>');
                    $('#form_wizard_1').find('.button-submit').hide();
                }
                if (current == 3) {

...
class InvoiceHelper
{
    public function sendInvoiceForApprovalNotification($paymentRequestID)
    {
        ...
        if (!empty($paymentRequestDetail)) {
            ...
            $customerID = $paymentRequestDetail->customer_id;
            $contractID = $paymentRequestDetail->contract_id;
            ...
            $uniqueUserIDs = array_unique(array_merge($invoiceUserWithApprovalAccessIDs, $adminRoleUserIDs, $contractUserWithFullAccess, $customerUserWithFullAccess));

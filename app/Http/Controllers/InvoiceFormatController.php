...
class InvoiceFormatController extends AppController
{
    ...
    function saveInvoiceFormat($request, $logo)
    {
        ...
        if ($request->template_type == 'construction') {
            $particular_column = '{"bill_code":"Bill Code","description":"Desc","bill_type":"Bill Type (% Complete or Unit)","original_contract_amount":"Original Contract Amount","approved_change_order_amount":"Approved Change Order Amount","current_contract_amount":"Current Contract Amount","previously_billed_percent":"Previously Billed Percent","previously_billed_amount":"Previously Billed Amount","current_billed_percent":"Current Billed Percent","current_billed_amount":"Current Billed Amount","stored_materials":"Stored Materials","total_billed":"Total Billed (including this draw)","retainage_percent":"Retainage %","retainage_amount_previously_withheld":"Retainage Amount Previously Withheld","retainage_amount_for_this_draw":"Retainage amount for this draw","net_billed_amount":"Net Billed Amount","retainage_release_amount":"Retainage Release Amount","total_outstanding_retainage":"Total outstanding retainage","project":"Project","cost_code":"Cost Code","cost_type":"Cost Type","group":"Group","bill_code_detail":"Bill code detail"}';
        }

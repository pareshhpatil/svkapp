...
class Invoice extends ParentModel
{
    ...
    public function getInvoiceConstructionParticularRows($payment_request_id)
    {
        $retObj = DB::table('invoice_construction_particular as i')
            ->select(DB::raw('i.id,i.bill_code,i.description,i.previously_billed_amount,i.current_contract_amount,i.current_billed_amount,i.stored_materials,i.total_outstanding_retainage,i.group,i.sub_group,i.bill_code_detail, csi_code.code'))
